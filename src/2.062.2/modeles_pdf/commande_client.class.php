...
protected function create_pdf_corps () {
	...
	//définition du contenu
		...
		$this->y +=5;
			...
			$this->Cell (20, 3, "A livrer le", 0, 0, 'L');
			...
			foreach ($this->fiches as $fiche) {
				...
				$this->Cell (13, 3, $fiche->lib_etat_doc, 0, 0, 'L');
				$this->SetTextColor(0);
				$this->Cell (6, 3, ")", 0, 0, 'L');
				$this->Cell (70, 3, substr($fiche->nom_contact,0,45), 0, 0, 'L');
				$this->Cell (20, 3, $fiche->date_livraison!='0000-00-00' ? date_Us_to_Fr($fiche->date_livraison):'', 0, 0, 'L');
