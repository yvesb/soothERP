...
class Modification_compte_user extends InscriptionModification {
	...
	protected function validation_modification_contact($ref_contact, $infos_from_modification){
		...
		if($ref_adresse_facturation != ""){// l'adresse de facturation exitse -> édition
			...
			$adresse->modification("Adresse de Facturation", $infos_contact['adresse_adresse'], $infos_contact['adresse_code'], $infos_contact['adresse_ville'], $infos_contact['id_pays_contact'], "");
		...
		if($ref_adresse_livraison != ""){//l'adresse de livraison existe -> édition
			...
			$adresse->modification("Adresse de Livraison", $infos_contact['livraison_adresse'], $infos_contact['livraison_code'], $infos_contact['livraison_ville'], $infos_contact['id_pays_livraison'], "");
			unset($adresse);
		...
		if($ref_coordonnee != ""){//l'adresse de livraison existe -> édition
			...
			$coordonnee->modification("Coordonnées principales", $infos_contact['coordonnee_tel1'], $infos_contact['coordonnee_tel2'], $infos_contact['coordonnee_fax'], $infos_contact['admin_emaila'], "", "");
		}else{//l'adresse de livraison n'existe pas -> création
