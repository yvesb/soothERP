...
$article = new article ($_REQUEST['assistant_ref_article']);
$article->add_formule_tarif ($_REQUEST['assistant_id_tarif'], $_REQUEST['assistant_indice_qte'], $formule);
// *************************************************************************************************************
// AFFICHAGE
// *************************************************************************************************************

include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_articles_edition_tarifs_formule.inc.php");
