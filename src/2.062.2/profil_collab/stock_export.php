...
<?php
	...
	<input type="hidden"  name="ref_art_categ"  value="<?echo $_REQUEST["ref_art_categ"];?>">
	<input type="hidden"  name="ref_constructeur"  value="<?echo $_REQUEST["ref_constructeur"];?>">
	<input type="hidden"  name="aff_pa"  value="<?echo $_REQUEST["aff_pa"];?>">
	<input type="hidden"  name="aff_info_tracab"  value="<?echo $_REQUEST["aff_info_tracab"];?>">
	<input type="hidden"  name="orderby"  value="<?echo $_REQUEST["orderby"];?>">
	<input type="hidden"  name="id_stock"  value="<?echo $_REQUEST["id_stock"];?>">
	<input type="hidden"  name="in_stock"  value="<?echo $_REQUEST["in_stock"];?>">
	<input type="hidden"  name="emplacement_s"  value="<?echo $_REQUEST["emplacement_s"];?>">
