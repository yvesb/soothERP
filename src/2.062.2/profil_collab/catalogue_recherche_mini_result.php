...
// TRAITEMENTS
// *************************************************************************************************************
$article_compose = false;
if (isset($_REQUEST['fonction_retour']) && ($_REQUEST['fonction_retour'] == "set_ref_article_to_fab" || $_REQUEST['fonction_retour'] == "set_ref_article_to_des")) {
$article_compose = true;
}
...
if (isset($_REQUEST['recherche'])) {
	...
	$query = "SELECT a.ref_article, a.ref_oem, a.ref_interne, a.lib_article, a.desc_courte, 
									 a.ref_constructeur, ann.nom nom_constructeur, a.dispo, a.id_valo, a.valo_indice,  a.lot,
									 ac.lib_art_categ, ac.modele, t.tva
									 ".$query_select."
...
if (!$article_compose) {
include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_recherche_mini_result.inc.php");
} else {
include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_recherche_mini_result_fab.inc.php");
}
