...
// Controle
	...
	$query = "SELECT ref_carac, lib_carac, unite, allowed_values, default_value, moteur_recherche, variante, affichage, 
						...
						WHERE acc.ref_art_categ = '".$_REQUEST['ref_art_categ']."' && moteur_recherche = 2 
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_recherche_categ_caract_avancee.inc.php");
