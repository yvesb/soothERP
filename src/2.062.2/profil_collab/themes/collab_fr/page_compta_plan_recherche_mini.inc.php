...
<div id="pop_up_compta_plan_add_mini_moteur" class="mini_moteur_add_compte_compta" style="display:none">
	...
	<script type="text/javascript">
	Event.observe("close_compta_plan_add_mini_moteur", "click",  function(evt){Event.stop(evt); close_compta_plan_add_mini_moteur();}, false);
	...
	centrage_element("pop_up_compta_plan_add_mini_moteur");
