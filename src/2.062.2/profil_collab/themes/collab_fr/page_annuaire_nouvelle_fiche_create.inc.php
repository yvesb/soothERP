...
if (isset ($_INFOS['Création_contact']) ) {
	...
	if (window.parent.return_to_page == "") {
		...
		if (window.parent.return_to_page.indexOf("compte_cbs") == 0)  {
		window.parent.page.verify('compte_bancaire','compta_compte_bancaire.php','true','sub_content');
		}
		window.parent.return_to_page = "";
	}
	<?php 
}
?>
