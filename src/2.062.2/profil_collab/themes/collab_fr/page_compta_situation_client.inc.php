        ...
        <table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF">
            ...
            <tr>
                <td style="text-align:left;" valign="top">
                    ...
                    <span class="titre_smenu_page" id="compte_client_prelevements" style="padding-left:100px;cursor:pointer"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce.png" align="absmiddle" />&nbsp;&nbsp;G&eacute;rer les autorisations de traites et de pr&eacute;l&egrave;vement</span><br /><br />
                        <?php endif; ?>
                </td>
                <td></td>
