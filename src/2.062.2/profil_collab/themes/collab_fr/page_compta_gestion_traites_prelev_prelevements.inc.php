...
<div class="titre" style="width:60%; padding-left:140px">Pr&eacute;l&egrave;vements vers <?php echo htmlentities($compte_bancaire->getLib_compte()); ?>
</div>
...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<div class="emarge"><br />
			...
			<br />
			Pr&eacute;l&egrave;vements vers <?php echo htmlentities($compte_bancaire->getLib_compte()); ?>
			</span>
			<br />
			<br />
