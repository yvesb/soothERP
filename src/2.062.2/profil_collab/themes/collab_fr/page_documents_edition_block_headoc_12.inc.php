									...
									<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
										<tr>
											...
											if ($document->getId_etat_doc () == 47) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_fab_afabriquer.gif" id="fab_afabriquer" style="cursor:pointer"/>
											...
											if ($document->getId_etat_doc () == 49) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_fab_encours.gif" id="fab_encours" style="cursor:pointer"/>
											<div style="height:3px;line-height:3px;" ></div>
											<?php 
											}
											?>
											...
											if ($document->getId_etat_doc () == 50) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_fab_terminee.gif" id="fab_terminee" style="cursor:pointer"/>
											<div style="height:3px;line-height:3px;" ></div>
											<?php 
											}
											?>
