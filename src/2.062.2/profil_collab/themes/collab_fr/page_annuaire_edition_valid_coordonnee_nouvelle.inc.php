...
?>
<p>&nbsp;</p>
<p>coordonnées: ajout d'un nouveau dans un contact existant </p>
<p>&nbsp; </p>
<?php 
...
<?php
if (isset($ref_coord_previous)) {
	?>
	window.parent.refreshtagmobil('coordlist2','li','coordcontent', 'annuaire_edition_valid_view_coordonnee_nouvelle', '<?php echo $ref_coord_previous?>', '');	
	<?php
}


if (isset($_INFOS['Création_coordonnée'])) {
	?>
	window.parent.switchtagmobil('coordlist2','li','coordcontent', 'annuaire_edition_valid_view_coordonnee_nouvelle', '<?php echo $_INFOS['Création_coordonnée']?>');
	<?php
}
?>
}
