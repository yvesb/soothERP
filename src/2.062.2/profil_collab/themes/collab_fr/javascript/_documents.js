...
function insert_line_nl (indentation_art, indentation_nl) {
	...
	$("more_nl_"+indentation_art+"_"+indentation_nl).innerHTML = "Nï¿½ de lot:";
...
function alert_qte_locked () {
	alerte.alerte_erreur ('Modification impossible', 'La modification de certains ï¿½lï¿½ments de ce document est interdite. <br /> Vous ne pouvez modifier les quantitï¿½s, prix  et les numï¿½ros de sï¿½rie de ces articles.','<input type="submit" id="bouton0" name="bouton0" value="Ok" />');
}
