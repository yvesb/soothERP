...
<br />
		...
		<tr>
			<td >
			<form action="documents_compta_4_mod.php" id="documents_compta_4_mod" name="documents_compta_4_mod" target="formFrame">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<tr>
						<td colspan="4">
						<div id="liste_comptes_3">
						<?php
						$i = 0;
						$montant = 0;
						$liste_ventil_ht = $ventillation_facture["3"];
		...
		&nbsp;
						...
						<td>
						<span style="color:#66CC33; font-weight:bolder; font-size:18px; cursor:pointer" id="doc_compta_add_line_3">+</span>
						</td>
					</tr>
					<tr>
						<td colspan="4">&nbsp;
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="4">
							<div id="liste_comptes_4">
							<?php
							$montant = 0;
							$liste_ventil_tva = $ventillation_facture["4"];
			...
			&nbsp;
							...
							<td>
							<span style="color:#66CC33; font-weight:bolder; font-size:18px; cursor:pointer" id="doc_compta_add_line_4">+</span>
							</td>
						</tr>
						<tr>
							<td colspan="4">&nbsp;
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan="4">
							<div id="liste_comptes_5">
							<?php
							$montant = 0;
							$liste_ventil_ttc = $ventillation_facture["5"];
...
<script type="text/javascript">
	Event.observe('doc_compta_add_line_3', 'click',  function(evt){
		Event.stop(evt);
		insert_compta_line("3");
	},false); 
	Event.observe('doc_compta_add_line_4', 'click',  function(evt){
		Event.stop(evt);
		insert_compta_line("4");
	},false); 

	Event.observe('documents_compta_4_mod', 'submit',  function(evt){
		Event.stop(evt);
		if (check_document_compta_lignes ()) {
			$("documents_compta_4_mod").submit();
		}
	},false); 
