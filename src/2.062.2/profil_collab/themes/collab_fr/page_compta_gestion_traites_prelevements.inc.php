...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
	...
	<form action="compta_gestion_traites_create.php" target="formFrame" method="post" name="prelevement_create" id="prelevement_create">
	<div >
	...
	<div  id="prelev_selection"  style="width:100%; display:none; background-color:#FFFFFF ">
		...
		<tr>
			<td  colspan="2"><br />
                            <span class="controle_sub_title">TRAITES ACCEPTEES</span><br /><br />
			<div style="width:95%;">
		...
		<div style=" width:660px;">
			<table width="100%">
				...
				<td style="width:100px; text-align:center">Date de traite
				</td>
				</tr>
			</table>
		<?php
		for ($j = 0 ; $j < $count_prelev_a_effectuer ; $j++ ) {
			...
			<div id="ligne_exist_chq_<?php echo $j;?>">
				...
				<input name="CHK_EXIST_PRELEV_<?php echo $j;?>" type="checkbox" id="CHK_EXIST_CHQ_<?php echo $j;?>" value="<?php echo $infos_prelev[$j]->montant;?>" />
                                <input id="id_compte_bancaire_autorisation_<?php echo$j; ?>" name="id_compte_bancaire_autorisation_<?php echo $j; ?>" value="<?php echo $infos_prelev[$j]->id_compte_bancaire_autorisation; ?>" type="hidden"/>
				<script type="text/javascript">
				...
				<td style="width:100px">
                                    <input name="date_prelev_<?php echo $j;?>" type="text" id="date_prelev_<?php echo $j;?>" value="<?php echo date_Us_to_Fr(date("Y-m-d")); ?>" class="classinput_xsize"   />
				</td>
				</tr>
				</table>
		...
		<div class="emarge"><br />
			...
			<table width="780" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<div style="width:235px; height:35px; line-height:35px; font-weight:bolder">Traite(s) restant(s)</div>		</td>
