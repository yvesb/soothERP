   ...
   <span style="font-style:italic;font-weight:bold;"> Autorisations de traites :</span>
    ...
    <?php if(empty($results_traitena)){
        ?> <tr>
           ...
           <td>
               <input type="button" name="add_autor_traitena" id="add_autor_traitena" value="Ajouter une autorisation de traite"/>
                  <script type="text/javascript">
    Event.observe('add_autor_traitena', "click", function(evt){
        $("pop_up_traitena").style.display = "block";
        page.traitecontent('pop_up_traitena_content_up','compta_gest_traitena_add.php?ref_contact=<?php echo $_REQUEST['ref_contact']; ?>','true','pop_up_traitena_content_up');
        Event.stop(evt);
    });
    </script>
           </td>
    ...
    <tr>
        ...
        <td>
            <span class="green_underlined" id="drca_<?php echo $resultat_traitena->id_compte_bancaire_autorisation; ?>">Editer</span>
            <!--| Supprimer-->
            <script type="text/javascript">
