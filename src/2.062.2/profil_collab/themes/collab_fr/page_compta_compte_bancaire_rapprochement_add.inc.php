...
?>
<p>&nbsp;</p>
<p>comptes bancaire (ajout rapprochement) </p>
<p>&nbsp; </p>
<?php 
...
if (erreur) {
	...
	if (operation_in_closed_exercice) {
		texte_erreur += "La date de l'opération correspond à un exercice comptable déjà clôturé.<br/> L'ajout de rapprochement  est impossible dans un exercice clôturé.<br />";
	} 
