<div class="headbar">
    <span id="link_close_pop_up_traites" style="float:right" class="clic">
        <img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/supprime.gif" border="0">
    </span>
    <script type="text/javascript">
        Event.observe("link_close_pop_up_traites", "click",  function(evt){Event.stop(evt); $("pop_up_traites").hide();}, false);
    </script>
</div>
<div class="popup-content">
    ...
    <table width="100%" border="0" cellspacing="4" cellpadding="2">
        <tr>
            <td colspan="2" style="width:15%; font-style: italic; font-weight: bold;">Modifier une autorisation de traite acceptée</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td style="width:45%">
                ...
                <input type="hidden" id="id_traites" name="id_traites" value="<?php echo $_REQUEST["id_traites"] ?>" />
            </td>
            <td>&nbsp</td>
            <td>&nbsp</td>
        </tr>
        ...
        <tr>
            <td>
                <span class="labelled">Autorisation de traite:</span>
            </td>
            <td>
                <select name="id_pj_traites" id="id_pj_traites" class="classinput_xsize">
                    <option value="0">Aucune...</option>
                </select>
            </td>
            <td><span class="clic" id="add_pj_traites">+</span></td>
            <td>&nbsp</td>
        </tr>
        <tr>
            <td>
    ...
    <script type="text/javascript">
        ...
        Event.observe('add_pj_traites', "click", function(evt){
            if($("ref_client").value != ""){
        ...
        preselect('<?php echo $current->id_piece_jointe_autorisation ?>', 'id_pj_traites');
