...
$page_variables = array ("_ALERTES", "fiches", "form['nom']", "form['id_profil']", "form['page_to_show']", "form['fiches_par_page']", "nb_fiches", "form['orderby']", "form['orderorder']");
...
//
	...
	$barre_nav .= barre_navigation($nb_fiches, $form['page_to_show'], 
                                       ...
                                       $debut, $cfg_nb_pages,
                                       'page_to_show_s',
																			 'page.utilisateur_recherche_simple()');
...
Event.observe("order_nom", "click",  function(evt){Event.stop(evt);$('orderby_s').value='nom'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="nom") {echo "DESC";} else {echo "ASC";}?>'; page.utilisateur_recherche_simple();}, false);

Event.observe("order_pseudo", "click",  function(evt){Event.stop(evt);$('orderby_s').value='pseudo'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="pseudo") {echo "DESC";} else {echo "ASC";}?>'; page.utilisateur_recherche_simple();}, false);


Event.observe("order_date", "click",  function(evt){Event.stop(evt);$('orderby_s').value='date'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="date") {echo "DESC";} else {echo "ASC";}?>'; page.utilisateur_recherche_simple();}, false);

Event.observe("order_ip", "click",  function(evt){Event.stop(evt);$('orderby_s').value='ip'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="ip") {echo "DESC";} else {echo "ASC";}?>'; page.utilisateur_recherche_simple();}, false);
