...
if (isset($_REQUEST["id_reglement_mode"])) {
	...
	switch ($infos ["id_reglement_mode"]) {
		//entrant espece
		case "1":
			$infos ["id_compte_caisse_dest"]			=	 $_REQUEST["id_compte_caisse_dest"];
		break;
		...
		//sortant espece
		case "7":
			$infos ["id_compte_caisse_source"]		=	 $_REQUEST["id_compte_caisse_source"];
		break;
	...
	foreach ($_REQUEST as $variable => $valeur) {
		...
		//echo $_REQUEST["id_compte_caisse_dest1"];

// *************************************************************************************************************
// AFFICHAGE
// -*************************************************************************************************************

//include ($DIR.$_SESSION['theme']->getDir_theme()."page_compta_reglement_maj.inc.php");
