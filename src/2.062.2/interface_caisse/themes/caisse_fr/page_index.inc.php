...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-15" />
		...
		<script src="<?php echo $DIR."profil_".$_SESSION['profils'][$ID_PROFIL]->getCode_profil()."/".$js_mod;?>"></script><?php 
					}
				}
			}
		} ?>
		...
		<script src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>javascript/_caisse.js"></script>
		<script src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>javascript/_calculette.js"></script>
