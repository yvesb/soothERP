...
<table width="100%">
	...
	<tr>
		<td class="titre_config" colspan="3">Consultation de l'historique du v&eacute;hicule <?php echo $vehicule->lib_vehicule;?> ( <?php echo $vehicule->marque;?> )</td>
	</tr>
	<tr>
		<td colspan="3"> </td>
	</tr>
	...
	<tr>
		<td class="titre_config" colspan="3">Liste des &eacute;v&eacute;nements :</td>
	</tr>
	<tr>
		<td colspan="3"></td>
	</tr>
	...
	<table border="0" cellpadding="0" cellspacing="0">
				...
				<td class="infos_config" width="165px">
					<span>Ev&eacute;nement </span>
				</td>
				<td class="infos_config" width="80px">
					<span>Co&ucirc;t </span>
				</td>
				<td width="160px"></td>
				<td width="40px"></td>
