...
if (erreur) {
  ...
  if (choisir_id_pdf_modele) {
    window.parent.document.getElementById("choix_id_pdf_stats").className="alerteform_xsize";
    texte_erreur += "Vous devez sélectionner un modèle de document source.<br/>";
  } else {
    window.parent.document.getElementById("choix_id_pdf_stats").className="classinput_xsize";
  }
...
window.parent.page.traitecontent('Communication_mod_fiche_stats','communication_mod_fiche_stats.php','true','sub_content');
