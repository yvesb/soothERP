...
if (lib_carac_vide) {
	window.parent.document.getElementById("lib_carac_<?php echo $_REQUEST['ref_carac']?>").className="alerteform_xsize";
	window.parent.document.getElementById("lib_carac_<?php echo $_REQUEST['ref_carac']?>").focus();
	} else {
	window.parent.document.getElementById("lib_carac_<?php echo $_REQUEST['ref_carac']?>").className="classinput_xsize";
		}
}
else
{
