...
?>
<p>&nbsp;</p>
<p>gestion categories_client  add </p>
<p>&nbsp; </p>
<?php 
...
if (erreur) {
	...
	if (bad_delai_reglement) {
		window.parent.document.getElementById("delai_reglement").className="alerteform_lsize";
		texte_erreur += "Le délai de règlement dois être une valeur comprise entre 0 et 255.<br/>";
	} else {
		window.parent.document.getElementById("delai_reglement").className="classinput_lsize";
	}
