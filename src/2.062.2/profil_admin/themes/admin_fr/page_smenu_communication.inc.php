...
<div>
	...
	<br/>
			<span class="titre_smenu_page" id="smenu_gerer_mod_export_resultat_commerciaux"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />G?rer les mod&egrave;les d'export pour les r&eacute;sultats commerciaux</span><br /><br />
			<span class="titre_smenu_page" id="smenu_gerer_mod_export_stats_vente"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />G?rer les mod&egrave;les d'export pour les statistiques de ventes</span><br /><br />
			<span class="titre_smenu_page" id="smenu_gerer_mod_export_etat_stocks"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />G?rer les mod&egrave;les d'export d'&eacute;tat de stocks</span><br /><br />
