		...
		<table class="minimizetable">
			...
			<tr>
				...
				if(empty($liste_fonctions_collab))  {
					...
					<td>
					<input type="checkbox" value="0" id="tous_collab" name="tous_collab" <?php if (!count($collab_fct) || !$collab_fct[0]) {?>checked="checked"<?php } ?> >Toutes 
			...
			<tr>
					...
					foreach ($liste_fonctions_collab as $fct_collab) {
						...
						<input type="checkbox" name="collab_fonction_<?php echo $fct_collab->id_fonction;?>" id="collab_fonction_<?php echo $fct_collab->id_fonction;?>" value="<?php echo $fct_collab->id_fonction;?>" <?php if(array_search($fct_collab->id_fonction, $collab_fct)!== false) { ?> checked="checked" <?php } ?> /><?php echo ($fct_collab->lib_fonction);?>
						<br />
					<script type="text/javascript">
