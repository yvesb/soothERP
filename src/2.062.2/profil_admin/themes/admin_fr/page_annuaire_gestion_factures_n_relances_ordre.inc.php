...
?>
<p>&nbsp;</p>
<p>gestion niveaux factures relances (ordre)</p>
<p>&nbsp; </p>
<?php 
...
window.parent.page.traitecontent('annuaire_gestion_factures','annuaire_gestion_factures.php?id_client_categ=<?php echo $_REQUEST["id_client_categ"];?>','true','sub_content');
