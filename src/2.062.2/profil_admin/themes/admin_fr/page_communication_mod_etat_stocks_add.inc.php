...
if (erreur) {
  ...
  if (choisir_id_pdf_modele) {
    window.parent.document.getElementById("choix_id_pdf_stocks").className="alerteform_xsize";
    texte_erreur += "Vous devez sélectionner un modèle de document source.<br/>";
  } else {
    window.parent.document.getElementById("choix_id_pdf_stocks").className="classinput_xsize";
  }
...
window.parent.page.traitecontent('Communication_mod_etat_stocks','communication_mod_etat_stocks.php','true','sub_content');
