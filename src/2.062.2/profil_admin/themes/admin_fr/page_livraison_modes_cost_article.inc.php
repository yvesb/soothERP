...
<form action="#" method="GET" id="form_recherche_s" name="form_recherche_s">
	...
	?>"   class="classinput_xsize"/>
		...
		<tr>
			...
			<input type="hidden" name="id_livraison_mode" id="id_livraison_mode" value="<?php echo $_REQUEST["id_livraison_mode"];?>" />
...
//lance la recherche
Event.observe('form_recherche_s', "submit", function(evt){page.article_livraison_modes_cost_recherche();  
	Event.stop(evt);});
