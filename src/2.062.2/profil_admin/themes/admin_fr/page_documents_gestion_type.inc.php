				...
				foreach ($document_type->doc_modeles_pdf as $modele_pdf) {
					...
					<table width="100%" border="0">
						<tr>
							...
							<td style="width:15%"><a href="configuration_pdf_preview.php?id_type_doc=<?php echo $document_type->id_type_doc; ?>&code_pdf_modele=<?php echo $modele_pdf->code_pdf_modele;?>" target="_blank" style="color:#000000">Visualiser</a></td>
							<td style="width:15%">
				...
				foreach ($document_type->doc_modeles_pdf as $modele_pdf) {
					...
					<table width="100%" border="0">
						<tr>
							...
							<td style="width:11%; color:#999999"><a href="configuration_pdf_preview.php?id_type_doc=<?php echo $document_type->id_type_doc; ?>&code_pdf_modele=<?php echo $modele_pdf->code_pdf_modele;?>" target="_blank" style="color:#000000">Visualiser</a></td>
