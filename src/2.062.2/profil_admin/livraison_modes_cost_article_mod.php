...
$base_calcul 				= $_REQUEST["base_calcul_". str_replace(".", "_", $_REQUEST["ref_article"])];
$liste_cost = array();
...
$livraison_mode->create_cost_ref_article($ref_article, $base_calcul, $liste_cost);
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_livraison_modes_cost_article_mod.inc.php");
