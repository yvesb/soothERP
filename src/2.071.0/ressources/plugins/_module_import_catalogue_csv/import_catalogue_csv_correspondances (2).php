...
// AFFICHAGE
//  ******************************************************
include ($CORE_DIR."profil_".$_SESSION['profils'][$ID_PROFIL]->getCode_profil()."/modules/".$import_catalogue_csv['folder_name']."themes/".$CHOIX_THEME."/".$_SESSION['theme']->getCode_theme()."/page_import_catalogue_csv_correspondances.inc.php");
