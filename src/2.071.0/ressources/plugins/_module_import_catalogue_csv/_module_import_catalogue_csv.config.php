...
GLOBAL $PROFILE_DIR;
$import_catalogue_csv['folder_name']			 = "_module_import_catalogue_csv/";
$import_catalogue_csv['import_images_folder']	 = "_module_import_catalogue/";

$import_catalogue_csv['menu_admin'][0]	 = array('separateur', '', 'true', '', '');
$import_catalogue_csv['menu_admin'][1]	 = array('import_catalogue_csv', $PROFILE_DIR.$PLUGINS_REP . $import_catalogue_csv['folder_name'] . '_module_import_catalogue_csv.php', 'true', 'sub_content', 'Import d\'articles depuis un fichier CSV ');

$import_catalogue_csv['css_admin'][0]	 = $PROFILE_DIR.$PLUGINS_REP . $import_catalogue_csv['folder_name'] . 'themes/css/import_catalogue_csv.css';
$import_catalogue_csv['js_admin'][0]	 = $PROFILE_DIR.$PLUGINS_REP . $import_catalogue_csv['folder_name'] . 'themes/js/import_catalogue_csv.js';
