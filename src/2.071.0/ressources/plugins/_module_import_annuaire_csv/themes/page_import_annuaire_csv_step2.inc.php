...
<form action="<?php echo $PROFILE_DIR.$PLUGINS_REP; ?>_module_import_annuaire_csv/import_annuaire_csv_step2_done.php" enctype="multipart/form-data" method="POST" id="import_annuaire_csv_done" name="import_annuaire_csv_done" target="formFrame" class="classinput_nsize" />
