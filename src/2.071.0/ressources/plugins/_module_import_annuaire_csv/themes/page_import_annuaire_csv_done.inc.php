...
window.parent.page.verify('default_content','<?php echo $PROFILE_DIR.$PLUGINS_REP; ?>_module_import_annuaire_csv/import_annuaire_csv_step1.php','true','sub_content');
