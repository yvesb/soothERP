...
for ($i = 0; $i < count($array_retour); $i++) {
	...
	?>
				<tr id="ligne_<?php echo $i; ?>" class="<?php echo $class_colorise ?>">
					...
					<td style="text-align:left" >
						<?php if (isset($array_retour[$i]["averti"])) { ?><img src="modules/<?php echo $import_annuaire_csv['folder_name']; ?>themes/<?php echo $_SESSION['theme']->getCode_gtheme(); ?>/images/ding.gif" title="Cette ligne pourrait ne pas être totalement importée"/><?php } ?>
						<?php if (isset($array_retour[$i]["alerte"])) { ?><img src="modules/<?php echo $import_annuaire_csv['folder_name']; ?>themes/<?php echo $_SESSION['theme']->getCode_gtheme(); ?>/images/alerte.gif" title="Cette ligne ne sera pas importée"/><?php } ?>
					</td>
					<td style="text-align:left" >
