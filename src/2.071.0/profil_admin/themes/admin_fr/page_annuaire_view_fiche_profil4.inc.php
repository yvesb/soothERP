...
<input type="hidden" name="id_profil" value="<?php echo $id_profil?>">
	<table class="minimizetable">
		...
		<script type="text/javascript" language="javascript">
			...
			Event.observe('img_encours_cadenas-ouvert',					'click', function(evt){toggle_cadenas_et_valeurs('flg_encours', 'encours', 'img_encours_cadenas-ouvert', 'img_encours_cadenas-ferme', 'listereadonly', 'ferme', 	'def_encours', 'retour_value_encours');$('retour_value_encours').value 					= $('def_encours').value;}, false);
			...
			Event.observe('img_id_tarif_cadenas-ouvert',				'click', function(evt){toggle_cadenas_et_valeurs('flg_id_tarif', 'id_tarif', 'img_id_tarif_cadenas-ouvert', 'img_id_tarif_cadenas-ferme', 'listereadonly', 'ferme', 	'def_id_tarif', 'retour_value_id_tarif');$('retour_value_id_tarif').value 					= $('def_id_tarif').value;}, false);
			...
			Event.observe('img_app_tarifs_cadenas-ouvert',				'click', function(evt){toggle_cadenas_et_valeurs('flg_app_tarifs', 'app_tarifs', 'img_app_tarifs_cadenas-ouvert', 'img_app_tarifs_cadenas-ferme', 'listereadonly', 'ferme', 	'def_app_tarifs', 'retour_value_app_tarifs');$('retour_value_app_tarifs').value 					= $('def_app_tarifs').value;}, false);
					...
					<td colspan="4">
						<select id="facturation_periodique" 
							...
							<option value="<?php echo $key;?>"
								<?php if ($profils[$id_profil]->getFactures_par_mois () == $key) {echo 'selected="selected"';} ?>
								<?php if ($ce_client['facturation_periodique'] == $categorie_client->facturation_periodique) { ?>
									<script type="text/javascript" language="javascript">
										toggle_cadenas_et_valeurs('flg_facturation_periodique', 'facturation_periodique', 'img_facturation_periodique_cadenas-ouvert', 'img_facturation_periodique_cadenas-ferme', 'listereadonly', 'ferme',	'def_facturation_periodique', 'retour_value_facturation_periodique');
									</script>						
