...
<script type="text/javascript">
	Event.observe('import_art_categ', 'click',  function(evt){
		Event.stop(evt); 
		page.traitecontent('serveur_import_data_1_','serveur_import_data_1.php?ref_serveur=<?php echo htmlentities($import_serveur->getRef_serveur_import (), ENT_QUOTES, "UTF-8");?>','true','sub_content');
	}, false);
