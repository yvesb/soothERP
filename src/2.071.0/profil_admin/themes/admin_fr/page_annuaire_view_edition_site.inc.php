		...
		<td>
			...
			<table class="infotable">
				...
				<tr>
					...
					<input id="site_lib<?php echo $caiu?>" name="site_lib<?php echo $caiu?>" type="text" class="classinput_xsize" value="<?php echo htmlentities($site_web->getLib_site_web(), ENT_QUOTES, "UTF-8")?>" />
					</td>
				</tr>
				...
				<tr>
					...
					<input id="site_url<?php echo $caiu?>" name="site_url<?php echo $caiu?>" class="classinput_xsize" value="<?php echo htmlentities($site_web->getUrl(), ENT_QUOTES, "UTF-8")?>" />
					</td>
				</tr>
				<tr>
					<td>
					<span class="labelled">Login:</span></td><td>
					<input name="site_login<?php echo $caiu?>" id="site_login<?php echo $caiu?>" class="classinput_xsize" value="<?php echo htmlentities($site_web->getLogin(), ENT_QUOTES, "UTF-8")?>" />
					</td>
				</tr>
				<tr>
					<td>
					<span class="labelled">Mot de passe:</span></td><td>
					<input id="site_pass<?php echo $caiu?>" name="site_pass<?php echo $caiu?>" type="text" class="classinput_xsize" value="<?php echo htmlentities($site_web->getPass(), ENT_QUOTES, "UTF-8")?>" />
					</td>
				</tr>
				<tr>
					<td>
					<span class="labelled">Note:</span></td><td>
					<textarea id="site_note<?php echo $caiu?>" name="site_note<?php echo $caiu?>" rows="2"  class="classinput_xsize"/><?php echo htmlentities($site_web->getNote(), ENT_QUOTES, "UTF-8")?></textarea>
					</td>
				</tr>
				<tr>
			...
			<table class="infotable" id="start_visible_<?php echo $caiu?>">
				...
				<tr>
					...
					<a href="#" id="link_show_site_lib<?php echo $caiu?>" class="modif_input2"><strong><?php echo  htmlentities($site_web->getLib_site_web(), ENT_QUOTES, "UTF-8")?></strong><?php if($site_web->getTypeLib() != ""){ ?>&nbsp;(<?php echo  htmlentities($site_web->getTypeLib(), ENT_QUOTES, "UTF-8")?>)<?php }?></a>
					<script type="text/javascript">
				...
				<tr>
					...
					<td>
					<a href="<?php if (!preg_match("#^((http|https|ftp)://)#", $site_web->getUrl())) {echo "http://";} ?><?php echo  $site_web->getUrl()?>" target="_blank" ><?php echo  htmlentities(substr(preg_replace("#(http://|https://|ftp://)(([[:punct:]]|[[:alnum:]])*)#",	"\\2", $site_web->getUrl()),0,20), ENT_QUOTES, "UTF-8")?>...</a>
					</td>
				</tr>
				<?php } ?>
				...
				<tr>
					<td>
					<span class="labelled">Login:</span></td><td>
					<a href="#" id="link_show_site_login<?php echo $caiu?>" class="modif_input1"><?php echo  htmlentities($site_web->getLogin(), ENT_QUOTES, "UTF-8")?></a>
					<script type="text/javascript">
				...
				<tr>
					<td>
					<span class="labelled">Mot de passe:</span></td><td>
					<a href="#" id="link_show_site_pass<?php echo $caiu?>" class="modif_input1"><?php echo  htmlentities($site_web->getPass(), ENT_QUOTES, "UTF-8")?></a>
					<script type="text/javascript">
				...
				<tr>
					<td>
					<span class="labelled">Note:</span></td><td>
					<a href="#" id="link_show_site_note<?php echo $caiu?>" class="modif_textarea3"><?php echo  nl2br(htmlentities($site_web->getNote()), ENT_QUOTES, "UTF-8")?></a>
					<script type="text/javascript">
