...
if (isset($_SESSION['USER_INFOS']['id_profil'])) {
    $id_profil = &$_SESSION['USER_INFOS']['id_profil'];
} else {
    $id_profil = "";
}
                ...
                <table width="100%" cellpadding=0 cellspacing=0 border=0 align="center">
                    <tr>
                        <td colspan="2" style="text-align:center; font-weight:bolder; line-height:20px; height:20px;  border-bottom:1px solid #000000;">
                            ...
                            <a href="#" id="close_ask_login"><img src="<?php echo $_ENV['CHEMIN_ABSOLU']; ?>themes/<?php echo $CHOIX_THEME; ?>/images/supprime.gif" border="0" style="float:right"></a>
