...
window.parent.page.traitecontent('compta_compte_bancaire_contact','compta_compte_bancaire_contact.php?ref_contact=<?php echo $_REQUEST["ref_contact"]?>','true','sub_content');
