									...
									<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
										<tr>
											...
											if ($document->getId_etat_doc () == 20) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_def_pret.gif" id="devis_pret" style="cursor:pointer"/>
											...
											if ($document->getId_etat_doc () == 22) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_def_accepte.gif" id="devis_accepte" style="cursor:pointer"/>
											<div style="height:3px; line-height:3px;"></div>

											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_def_refuse.gif" id="devis_refuse" style="cursor:pointer"/>
											<div style="height:3px; line-height:3px;"></div>
											<?php
											}
											?>
