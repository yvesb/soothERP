...
Event.stop(evt); 
page.verify ('compta_livraisons_client_nonfacturees_liste','compta_livraisons_client_nonfacturees_liste.php?orderby=date_creation&orderorder=<?php if (isset($_REQUEST['orderorder']) && $_REQUEST['orderorder']=="ASC" && $_REQUEST['orderby']=="date_creation") {echo "DESC";} else {echo "ASC";}?>&id_stock=<?php echo $stocks->getId_stock();?>','true','lcnf');
}, false);
					</script>
				</td>
...
Event.stop(evt); 
page.verify ('compta_livraisons_client_nonfacturees_liste','compta_livraisons_client_nonfacturees_liste.php?orderby=ref_doc&orderorder=<?php if (isset($_REQUEST['orderorder']) && $_REQUEST['orderorder']=="ASC" && $_REQUEST['orderby']=="ref_doc") {echo "DESC";} else {echo "ASC";}?>&id_stock=<?php echo $stocks->getId_stock();?>','true','lcnf');
}, false);
					</script>
				</td>
				<td style="font-weight:bolder;text-align:left; font-weight:bolder;" valign="middle">
					<div style=" height:24px; line-height:24px; cursor:pointer;" id="order_nom_contact_<?php echo $stocks->getId_stock ();?>">Client
					</div>
					<script type="text/javascript">
Event.observe("order_nom_contact_<?php echo $stocks->getId_stock ();?>", "click",  function(evt){
Event.stop(evt); 
page.verify ('compta_livraisons_client_nonfacturees_liste','compta_livraisons_client_nonfacturees_liste.php?orderby=nom_contact&orderorder=<?php if (isset($_REQUEST['orderorder']) && $_REQUEST['orderorder']=="ASC" && $_REQUEST['orderby']=="nom_contact") {echo "DESC";} else {echo "ASC";}?>&id_stock=<?php echo $stocks->getId_stock();?>','true','lcnf');
}, false);
					</script>
				</td>
			...
			<tr valign="middle">
				<td style="width:25px; height:24px; line-height:24px;" valign="middle">
					<div style="width:25px;">
						...
						<input id="refdoc_<?php echo $stocks->getId_stock ();?>_<?php echo $indentation;?>" name="refdoc_<?php echo $stocks->getId_stock ();?>_<?php echo $indentation;?>" type="hidden" value="<?php echo htmlentities($livraison->ref_doc, ENT_QUOTES, "UTF-8");?>"/>
					</div>
				</td>
