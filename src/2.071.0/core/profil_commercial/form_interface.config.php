<?php
//  **********************************************
// FORMULAIRE DE CONFIG - INTERFACE COMMERCIAL
//  **********************************************
...
$string_config_file = file_get_contents($CORE_DIR."profil_commercial/_interface.config.php");
require($CORE_DIR."profil_commercial/_interface.config.php");
$matches = array();
...
<form id="configure_interface" name="configure_interface" enctype="multipart/form-data" action="<?php echo $CORE_DIR; ?>profil_commercial/site_interfaces_config.generate.php" method="POST" target="formFrame">
	<div id="confint">
  <input id="file_path" name="file_path" type="hidden" value="profil_commercial/_interface.config.php" /> 
  <table width="100%">
