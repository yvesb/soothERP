				...
				<table style="width:97%">
					...
					<tr>
						...
						<td><span class="labelled_text">Par magasin:</span>
							<input type="hidden" name="ref_client_c" id="ref_client_c" value="<?php if (isset($_REQUEST["ref_contact_docsearch"])) {
	echo $_REQUEST["ref_contact_docsearch"];
} ?>" />
					...
					foreach ($liste_mag as $mag) {
						$i = 1;
						?>
						<option value="<?php echo $mag->id_magasin; ?>" <?php if ($mag->id_magasin == $_SESSION['magasin']->getId_magasin()) {
						echo ' selected="selected"';
					} ?> ><?php echo htmlentities($mag->lib_magasin, ENT_QUOTES, "UTF-8"); ?></option>
						<?php
						$i++;
					}
					?>
...
<?php $i			 = 1; ?>
					...
					foreach ($liste_stock as $stock) {
						?>
						<option value="<?php echo $stock->id_stock; ?>" <?php if (isset($_REQUEST["id_stock"]) && $stock->id_stock == $_REQUEST["id_stock"]) {
						echo ' selected="selected"';
					} ?> ><?php echo htmlentities($stock->lib_stock, ENT_QUOTES, "UTF-8"); ?></option>
	<?php
}
?>
					</select>			</td>
...
?>
								...
								<tr>
									<td>
										<span style=" width:100%;" class="simule_champs" id="liste_de_constructeur_c">
											<span id="ref_constructeur_nom_c" style=" float:left; height:18px; margin-left:3px; line-height:18px;"><?php if (isset($_REQUEST["lib_constructeur_docsearch"])) {
	echo (urldecode($_REQUEST["lib_constructeur_docsearch"]));
							...
							<script type="text/javascript">
								...
								Event.observe('ref_constructeur_select_c', 'mouseover', function () {
									$("ref_constructeur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_hover.gif";
								}, false);
								Event.observe('ref_constructeur_select_c', 'mousedown', function () {
									$("ref_constructeur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_down.gif";
								}, false);
								Event.observe('ref_constructeur_select_c', 'mouseup', function () {
									$("ref_constructeur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);

								Event.observe('ref_constructeur_select_c', 'mouseout', function () {
									$("ref_constructeur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);
								Event.observe('ref_constructeur_select_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_constructeur_c\', \'ref_constructeur_nom_c\' ");
									preselect('<?php echo $CONSTRUCTEUR_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
								}, false);
								Event.observe('liste_de_constructeur_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_constructeur_c\', \'ref_constructeur_nom_c\' ");
									preselect('<?php echo $CONSTRUCTEUR_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
						...
						<td>
							...
							<script type="text/javascript">
								Event.observe('ref_constructeur_empty_c', 'click', function (evt) {
									Event.stop(evt);
								...
								<tr>
									<td>
										<span style=" width:100%;" class="simule_champs" id="liste_de_client_c">
											<span id="ref_client_nom_c" style=" float:left; height:18px; margin-left:3px; line-height:18px;"><?php if (isset($_REQUEST["lib_client_docsearch"])) {
	echo (urldecode($_REQUEST["lib_client_docsearch"]));
} else { ?>Tous<?php } ?></span>						</span>						</td>
									<td style="width:28px; text-align:right">
							...
							<script type="text/javascript">
								...
								//effet de survol sur le faux select
								Event.observe('ref_client_select_c', 'mouseover', function () {
									$("ref_client_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_hover.gif";
								}, false);
								Event.observe('ref_client_select_c', 'mousedown', function () {
									$("ref_client_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_down.gif";
								}, false);
								Event.observe('ref_client_select_c', 'mouseup', function () {
									$("ref_client_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);

								Event.observe('ref_client_select_c', 'mouseout', function () {
									$("ref_client_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);
								Event.observe('ref_client_select_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_client_c\', \'ref_client_nom_c\' ");
									preselect('<?php echo $CLIENT_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
								}, false);
								Event.observe('liste_de_client_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_client_c\', \'ref_client_nom_c\' ");
									preselect('<?php echo $CLIENT_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
						...
						<td>
							...
							<script type="text/javascript">
								Event.observe('ref_client_empty_c', 'click', function (evt) {
									Event.stop(evt);
									$("ref_client_c").value = "";
								...
								<tr>
									<td>
										<span style=" width:100%;" class="simule_champs" id="liste_de_fournisseur_c">
											<span id="ref_fournisseur_nom_c" style=" float:left; height:18px; margin-left:3px; line-height:18px;"><?php if (isset($_REQUEST["lib_fournisseur_docsearch"])) {
	echo (urldecode($_REQUEST["lib_fournisseur_docsearch"]));
} else { ?>Tous<?php } ?></span>						</span>						</td>
									<td style="width:28px; text-align:right">
							...
							<script type="text/javascript">
								...
								//effet de survol sur le faux select
								Event.observe('ref_fournisseur_select_c', 'mouseover', function () {
									$("ref_fournisseur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_hover.gif";
								}, false);
								Event.observe('ref_fournisseur_select_c', 'mousedown', function () {
									$("ref_fournisseur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find_down.gif";
								}, false);
								Event.observe('ref_fournisseur_select_c', 'mouseup', function () {
									$("ref_fournisseur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);

								Event.observe('ref_fournisseur_select_c', 'mouseout', function () {
									$("ref_fournisseur_select_img_c").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt_contact_find.gif";
								}, false);
								Event.observe('ref_fournisseur_select_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_fournisseur_c\', \'ref_fournisseur_nom_c\' ");
									preselect('<?php echo $FOURNISSEUR_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
								}, false);
								Event.observe('liste_de_fournisseur_c', 'click', function (evt) {
									Event.stop(evt);
									show_mini_moteur_contacts("recherche_docu_set_contact", "\'ref_fournisseur_c\', \'ref_fournisseur_nom_c\' ");
									preselect('<?php echo $FOURNISSEUR_ID_PROFIL; ?>', 'id_profil_m');
									page.annuaire_recherche_mini();
					...
					<tr>
						...
						<td><span id="imprimer_commande_client" style="cursor:pointer; text-decoration:underline">Imprimer les Commandes clients</span>
							<SCRIPT type="text/javascript">
								Event.observe("imprimer_commande_client", "click", function (evt) {
									page.documents_pdf_cmde_client();
									Event.stop(evt);
								});
							</SCRIPT></td>
						<td></td>
	...
	//remise à zero du formulaire
		Event.observe('annuler_recherche_c', "click", function (evt) {
			Event.stop(evt);
			$('form_recherche_c').reset();
		});
	//lance la recherche
		Event.observe('form_recherche_c', "submit", function (evt) {
			page.documents_recherche_cmde();
			Event.stop(evt);
		});
...
<?php } ?>
				...
				if (historique_request[6]["cmdecours_c"] == "1") {
					$('cmdecours_c').checked = true;
				}
				if (historique_request[6]["cmderec_c"] == "1") {
					$('cmderec_c').checked = true;
				}
				if (historique_request[6]["cmderetard_c"] == "1") {
					$('cmderetard_c').checked = true;
				}
				if (historique_request[6]["cmdeavalid_c"] == "1") {
					$('cmdeavalid_c').checked = true;
				}
				if (historique_request[6]["cmdeaprep_c"] == "1") {
					$('cmdeaprep_c').checked = true;
				}
