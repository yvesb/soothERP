...
class Inscription_compte_user extends InscriptionModification {
	...
	public function inscription_contact($infos_contact, $email) {
		...
		switch ($this->getInscription_allowed()) {
			...
			case 1 : {
					return $this->inscription_contact_avec_validation_sans_mail_confirmation($infos_contact, $email);
					break;
				}
			case 3 : {
					return $this->inscription_contact_avec_validation_avec_mail_confirmation($infos_contact, $email);
					break;
				}

			case 2 : {
					return $this->inscription_contact_automatique_sans_mail_confirmation($infos_contact, $email);
					break;
				}
			case 4 : {
					return $this->inscription_contact_automatique_avec_mail_confirmation($infos_contact, $email);
					break;
				}
	...
	protected function inscription_contact_avec_validation_sans_mail_confirmation($infos_contact, $email) {
		...
		return $this->envoi_email_templated($email_contact, $sujet_pour_contact, $message_pour_contact) && $this->envoi_email_templated($email_collaborateur, $sujet_pour_collaborateur, $message_pour_collaborateur);
	}
	...
	protected function inscription_contact_avec_validation_avec_mail_confirmation_get_message_pour_contact($id_contact_tmp, $code_validation) {
		...
		http://" . $_SERVER['HTTP_HOST'] . "/" . $my_pathinfo["dirname"] . "/" . $CORE_REP . "/" . $this->getDossier() . "_inscription_valide.php?id_contact_tmp=" . $id_contact_tmp . "&code_validation=" . $code_validation . "<br />
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	...
	public function contact_confirme_son_inscription($id_contact_tmp, $code) {
		...
		switch ($this->getInscription_allowed()) {
			...
			case 1 : {
					return false;
				} //la confirmation n'est pas néncessaire
			case 3 : {
					return $this->contact_confirme_son_inscription_puis_validation_par_collab($id_contact_tmp, $code);
					break;
				}
			...
			case 4 : {
					return $this->contact_confirme_son_inscription_puis_validation_automatique($id_contact_tmp, $code);
					break;
				}
	...
	public function &validation_inscription_contact_par_collaborateur($id_contact_tmp) {
		...
		switch ($this->getInscription_allowed()) {
			case 1 : case 2 : case 3: case 4 : {
					break;
				} //les inscriptions sont permises
			default : {
					return $null;
				}
		}
	...
	public static function getInscriptions_attendant_validation($validation_email = -1, $id_contact_tmp = null) {
		...
		elseif (!is_numm($id_contact_tmp)) $query .= "&&		id_contact_tmp = '" . $id_contact_tmp . "'";
		$query .= ";";
	...
	public function getInscription_allowed() {
		if (!isset($this->inscription_allowed)) {
			...
			return $this->inscription_allowed;
		}
	}
