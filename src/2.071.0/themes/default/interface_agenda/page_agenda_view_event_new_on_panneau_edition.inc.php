...
<?php if(isset($_COOKIE["cook_agenda_selected"])){ ?>
	if($("evt_edition_agenda_selected").length > <?php echo $_COOKIE["cook_agenda_selected"] ?>){		
		majSelect_Options_events_types(<?php  echo $_COOKIE["cook_agenda_selected"];?>, $("evt_edition_agenda_selected").options[<?php echo $_COOKIE["cook_agenda_selected"] ?>].value, $("evt_edition_type_event_selected"));		
		majSelect_type_formulaire($("evt_edition_agenda_selected").options[<?php echo $_COOKIE["cook_agenda_selected"] ?>].value, $("panneau_event_formulaire_type"));
	}else{
...
if($("evt_edition_agenda_selected").length > <?php echo $_COOKIE["cook_agenda_selected"] ?>){
	$("evt_edition_agenda_selected").selectedIndex = <?php echo $_COOKIE["cook_agenda_selected"] ?>;
}
//  ************
