                    ...
                    <td width="350px" rowspan="2">
                        <table border="0" cellpadding="0px" cellspacing="4px" style="margin-top:8px; margin-right:8px; vertical-align:middle;" align="right">
                            <tr height="24px">
                                ...
                                <td>
                                    <img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme(); ?>images/bt_actualiser.gif" 	alt="Actualiser" title="Actualiser" class="btnostyle" id="refresh_content" />
                                </td>
                                <td>
