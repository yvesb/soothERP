<?php
//  *******
// ACCUEIL DU PROFIL COLLAB - Interface CAISSE
//  *******
...
// Liste des profils autorisés
                                                ...
                                                <tr>
                                                    <td>
                                    <img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme(); ?>images/actualiser_adm.gif" 	alt="Actualiser" title="Actualiser" id="refresh_content" />
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="2">
            <tr>
                ...
                <td width="292px">
                    ...
                    <table cellspacing="1" cellpadding="2" style="-moz-user-select:none;width:100%; border:0;" >
                        ...
                        <div id="conteneur_TICKET">
                            <div>
                                <table 	width="100%" border="0" cellpadding="3" cellspacing="0">                        
									<thead>
										<tr class="ticket_titre">
											<td style="width:4px;background-image:url('<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/fond_entete_rouge_left.png');background-repeat: no-repeat;"></td>
											<td style="text-align:center; border-right: 1px solid;">Libellé</td>
											<td style="width:40px;text-align:center; border-right: 1px solid;">Qté</td>
											<td style="width:100px;text-align:center; border-right: 1px solid;">P.U TTC</td>
											<td style="width:51px;text-align:center; border-right: 1px solid;">%</td>
											<td style="width:100px;text-align:center;">Prix TTC</td>
											<td style="width:6px;background-image:url('<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/fond_entete_rouge_right.png');background-repeat: no-repeat;"></td>
										</tr>
									</thead>
									<tbody id="TICKET" >
										<tr style="height: 240px; margin-bottom: -225px;">
											<td class="blank" style="width:4px;"></td>
											<td style="border-right: 1px solid #E1E2E1;"></td>
											<td style="width:40px;border-right: 1px solid #E1E2E1;"></td>
											<td style="width:100px;border-right: 1px solid #E1E2E1;"></td>
											<td style="width:51px;border-right: 1px solid #E1E2E1;"></td>
											<td style="width:100px;border:none!important;"></td>
                                ...
                                <td width="288px">
                                    ...
                                    <table id="panneau_fonctionnalites_avancees" style="text-align:center; display:none;" border="0" cellpadding="0" cellspacing="0"  width="100%" >
                                        <tr height="48px">
                                            ...
                                            <td width="6px"></td>
                                            <td class="panneau_fonctionnalites_bouton_<?php
											if ($afficher_magasin) {
												echo "active";
											} else {
												echo "desactive";
...
<!-- POPUP STATS -->
<?php
echo '<div id="popup_stats" style="display:none;" class="popup_stats"></div>';
?>
...
<script type="text/javascript">
	...
	Event.observe(bt_PlusMoins.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_PlusMoins_click();
	}, false);
	...
	Event.observe(bt_0.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("0");
	}, false);
	Event.observe(bt_1.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("1");
	}, false);
	Event.observe(bt_2.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("2");
	}, false);
	Event.observe(bt_3.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("3");
	}, false);
	Event.observe(bt_4.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("4");
	}, false);
	Event.observe(bt_5.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("5");
	}, false);
	Event.observe(bt_6.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("6");
	}, false);
	Event.observe(bt_7.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("7");
	}, false);
	Event.observe(bt_8.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("8");
	}, false);
	Event.observe(bt_9.id, "click", function (evt) {
		Event.stop(evt);
		calculette_caisse.bt_0_9_click("9");
	}, false);
