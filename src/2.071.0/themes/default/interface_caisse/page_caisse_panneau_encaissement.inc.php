...
<div class="panneau_bas">
					...
					<script type="text/javascript">
						Event.observe("print_valider", "click", function (evt) {
							...
							if (reglement_a_rendre >= 0) {
								...
								{
									alert("RESTE A PAYER : " + (-1) * reglement_a_rendre + "&nbsp;&euro;");
								}
								else {
									alert("Vous devez d'abord sélectionner un Moyen de Paiement");
								}
							}
						}, false);
					</script>
				...
				if (isset($avoir->montant_ttc)) {
					...
					<tr>
						...
						<td style="text-align:left;">
							/<?php if ($avoir->montant_ttc) {
						echo number_format($avoir->montant_ttc, $TARIFS_NB_DECIMALES, ".", "");
					} ?>
						</td>
						<td>
	...
	<?php }
			...
			<tr>
				...
				<td style="font-weight:bolder; text-align:right "><?php echo $montant_total . " " . $MONNAIE[1];
; ?> </td>
				<td ></td>
				<td ></td>
			</tr>
