<?php
//  ***********
// PAGE INDEX DU PROFIL COLLAB - Interface CAISSE
//  ***********
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	<head>
		...
		<link href="<?php echo $DIR . $_SESSION['theme']->getDir_css() ?>_caisse_style.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>prototype.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_helper.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>scriptaculous/scriptaculous.js?load=effects,dragdrop"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>selectupdater.js"></script>
		<?php
		if (isset($modules)) {
			foreach ($modules as $module) {
		...
		?>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_tab_alerte.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_row_menu.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_main_menu.js"></script>

		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_compte_tpe.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_compte_cb.js"></script>

		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_small_wysiwyg.js"></script>

		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>swfobject.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_general.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_caisse.js"></script>
		<script type="text/javascript" src="<?php echo $DIR . $_SESSION['theme']->getDir_js() ?>_calculette.js"></script>
	...
	<body style="background-repeat:repeat-x; background-attachment:fixed">
		<div id="grand_contener" class="<?php echo $_SESSION['interfaces'][$_INTERFACE['ID_INTERFACE']]->getLib_interface(); ?>">
...
<?php } ?>
			...
			<table cellspacing="0" cellpadding="0" border="0" style="position:absolute; left:0px; height:100%; width:100%;">
				<tr>
					<td style="width:3%">&nbsp;</td>
					<td>
...
<?php if ($AFFICHE_DEBUG) { ?>
				<div  style="display:block; position:absolute; top:0px; left:5px; z-index:500; width:10px">
									...
									<table width="100%" cellpadding=0 cellspacing=0 border=0 align="center">
										...
										<tr>
											<td colspan=2 align="right">	
												<a href="#" onclick="window.open('../site/__session_stop.php', '_top');" style="text-decoration:none">Quitter</a>
												<script type="text/javascript">
