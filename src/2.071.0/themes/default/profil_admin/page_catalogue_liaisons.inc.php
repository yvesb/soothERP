	...
	<div class="caract_table" id="liaison_table_<?php echo $liaison_liste->id_liaison_type; ?>">
		...
		<tr>
			...
			<input name="id_liaison_type" id="id_liaison_type" type="hidden" value="<?php echo $liaison_liste->id_liaison_type; ?>" />
						...
						<td>
						<input id="actif_<?php echo $liaison_liste->id_liaison_type; ?>" name="actif_<?php echo $liaison_liste->id_liaison_type; ?>" value="<?php echo htmlentities($liaison_liste->actif, ENT_QUOTES, "UTF-8"); ?>" type="checkbox"  <?php if($liaison_liste->actif==1){echo 'checked="checked"';}?>/>
						</td>
						<td>
