	...
	<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF">
		<tr>
			<td rowspan="4" style="width:280px; height:50px">
				...
				<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/ico_secusys.jpg" />				</div>
			...
			<td colspan="2" style="width:80%"><span style="width:40%; height:50px"><br />
				<br />
					<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/titre_secutite_sys.jpg" style="padding-left:25px" /><br />
			<br />
				<br />
			</span>			</td>
			</tr>
		<tr>
			<td style="text-align:left;" valign="top">
				...
				<span class="titre_smenu_page" id="smenu_secusys_session"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_grey.jpg" align="absmiddle" />Définir la durée des sessions</span><br /><br />
				
				<span class="titre_smenu_page_unvalid" id="smenu_secusys_niv_secu"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_grey.jpg" align="absmiddle" />Régler les niveaux de sécurité</span><br />
				<br />
			<span class="titre_smenu_page" id="smenu_secusys_liste_admin"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_grey.jpg" align="absmiddle" />Liste des administrateurs</span><br />
			<br />		</td>
			<td style="text-align:left;" valign="top">
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" width="100%" height="20px"/><br />
			
<span class="titre_smenu_page" id="smenu_secusys_histo"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_grey.jpg" align="absmiddle" />Historique des connexions utilisateurs</span><br />
			<br />	
			
				<span class="titre_smenu_page" id="smenu_secusys_liste_collab"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_grey.jpg" align="absmiddle" />Liste des collaborateurs</span><br />
				<br />		</td>
		</tr>
	</table>
</div>
