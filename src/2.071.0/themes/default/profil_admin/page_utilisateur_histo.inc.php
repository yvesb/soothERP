...
tableau_smenu[1] = Array('utilisateur_histo','utilisateur_histo.php' ,"true" ,"sub_content", "Historique des connexions des utilisateurs");
update_menu_arbo();
</script>
<div class="emarge">
<p class="titre">Historique des connexions des utilisateurs</p>
