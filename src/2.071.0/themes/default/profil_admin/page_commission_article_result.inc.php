...
foreach ($fiches as $fiche){
	?>
		<tr id="line_comm_article_<?php echo $fiche->ref_article;?>" style="">
			...
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/supprime.gif" id="del_formule_comm_<?php echo $fiche->ref_article;?>_<?php echo $comm_regle->id_commission_regle; ?>" style="cursor:pointer"/>
