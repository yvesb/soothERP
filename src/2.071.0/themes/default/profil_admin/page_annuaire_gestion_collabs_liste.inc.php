...
<div class="emarge">
	...
	<div id="recherche" class="corps_moteur">
		<div id="recherche_simple" class="menu_link_affichage">
			<form action="#" id="form_recherche_simple" name="form_recherche_simple" method="GET" onsubmit="page.annuaire_recherche_collabs();
				return false;">
				<table style="width:97%">
					...
					<tr>
						...
						<td><input type="text" name="nom_s" id="nom_s" value="<?php if (isset($_REQUEST["acc_ref_contact"])) {
					echo htmlentities($_REQUEST["acc_ref_contact"], ENT_QUOTES, "UTF-8");
				}
