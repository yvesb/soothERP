...
<table cellpadding="0" cellspacing="0" class="adm_tbl">
	...
	<tr>
		<td style="text-align:left;" valign="top">
			...
			<span class="titre_smenu_page" id="recherche_contact"><img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/puce_grey.jpg" align="absmiddle" />Recherche de contact</span><br /><br />
			<span class="titre_smenu_page" id="recherche_article"><img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/puce_grey.jpg" align="absmiddle" />Recherche d'articles</span><br /><br />
			<span class="titre_smenu_page" id="recherche_com_vente"><img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/puce_grey.jpg" align="absmiddle" />Recherche de documents commerciaux - Vente</span><br /><br />
			<span class="titre_smenu_page" id="recherche_com_achat"><img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/puce_grey.jpg" align="absmiddle" />Recherche de documents commerciaux - Achat</span><br /><br />
			<span class="titre_smenu_page" id="recherche_com_stock"><img src="<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/puce_grey.jpg" align="absmiddle" />Recherche de documents commerciaux - Stock</span><br /><br />
