										...
										<tr id="tache_<?php echo $tache->id_tache_admin; ?>_l">
											...
											<td style="text-align:right;">
												...
												<script type="text/javascript">
													...
													Event.observe('go_tache_<?php echo $tache->id_tache_admin; ?>_2', "click", function (evt) {
														page.verify('tache', '<?php echo $tache->url_action; ?>', 'true', 'sub_content');
														Event.stop(evt);
													});
													Event.observe('go_tache_<?php echo $tache->id_tache_admin; ?>_3', "click", function (evt) {
														page.verify('mes_taches', '<?php echo $tache->url_action; ?>', 'true', 'sub_content');
														Event.stop(evt);
													});
...
//nouvelle maj dispo
									if (0 == 1 /* Ne jamais proposer de mise à jour, incompatible avec SoothERP. isset($_SESSION['NEW_MAJ_DISPO']) && $_SESSION['NEW_MAJ_DISPO'] != "0" */) {
										...
										<script type="text/javascript">
											Event.observe("id_new_maj_dispo2", "click", function () {
												page.verify('import_maj_serveur', 'import_maj_serveur.php', 'true', 'sub_content');
											}, false);
				...
				<div style="height:55px">
					...
					if (isset($profils_allowed[$COLLAB_ID_PROFIL])) {
						...
						<script type="text/javascript">
							Event.observe('go_profil_collab', 'click', function (evt) {
								Event.stop(evt);
								window.open("<?php echo $CORE_DIR; ?>site/__user_choix_profil.php?id_profil=<?php echo $COLLAB_ID_PROFIL; ?>", "_top");
									}, false);
						</script>
						<?php
					}
...
//observateur pour parametrage
	Event.observe("osmenu_entreprise", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_entreprise', 'smenu_entreprise.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_annuaire", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_annuaire', 'smenu_annuaire.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_catalogue", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_catalogue', 'smenu_catalogue.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_comptabilite", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_comptabilite', 'smenu_comptabilite.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_affichage", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_affichage', 'smenu_affichage.php', "true", "sub_content");
	}, false);

//observateurs pour gestion
	Event.observe("osmenu_utilisateurs", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_utilisateurs', 'smenu_utilisateurs.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_site_internet", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_site_internet', 'smenu_site_internet.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_communication", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_communication', 'smenu_communication.php', "true", "sub_content");
	}, false);

//observateurs pour systeme
	Event.observe("osmenu_secusys", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_secusys', 'smenu_secusys.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_maintenance", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_maintenance', 'smenu_maintenance.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_transfert_donnees", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_transfert_donnees', 'smenu_transfert_donnees.php', "true", "sub_content");
	}, false);
	Event.observe("osmenu_gestion_modules", "click", function (evt) {
		Event.stop(evt);
		page.verify('smenu_gestion_modules', 'smenu_gestion_modules.php', "true", "sub_content");
	}, false);
...
//Event.observe("osmenu_maj", "click",  function(evt){Event.stop(evt); page.verify('import_maj_serveur','import_maj_serveur.php' ,"true" ,"sub_content");}, false);
	...
	Event.observe("menu_accueil_0", "click", function (evt) {
		Event.stop(evt);
		view_menu_accueil('systeme_liste', 'menu_accueil_0', array_menu_accueil, "accueil_onglet_hide", "accueil_onglet");
	}, false);
	Event.observe("menu_accueil_1", "click", function (evt) {
		Event.stop(evt);
		view_menu_accueil('taches_liste', 'menu_accueil_1', array_menu_accueil, "accueil_onglet_hide", "accueil_onglet");
	}, false);
	Event.observe("menu_accueil_2", "click", function (evt) {
		Event.stop(evt);
		view_menu_accueil('histo_liste', 'menu_accueil_2', array_menu_accueil, "accueil_onglet_hide", "accueil_onglet");
	}, false);
...
<?php if (isset($_REQUEST["fc_ad"])) { ?>
		...
		Event.observe("close_acc_wecome", "click", function (evt) {
			Event.stop(evt);
			$("acc_welcome").hide();
		}, false);
		$("acc_welcome").show();
