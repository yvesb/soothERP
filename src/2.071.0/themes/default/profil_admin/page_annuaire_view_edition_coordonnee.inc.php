<table class="minimizetable">
	<tr>
		...
		<table class="infotable" id="start_visible_<?php echo $caiu?>">
			...
			<tr>
				<td>
				<span class="labelled">Email:</span></td><td><a href="mailto:<?php echo $coordonnee->getEmail();?>"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/mail.gif"  border="0" style="float:right" vspace="5"/></a>
