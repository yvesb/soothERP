...
<table  cellspacing="0" id="tableresult">
	<tr class="colorise0">
		...
		<td style="width:30%"><a href="#"  id="order_nom"> Nom du contact </a> </td>
		<td style="width:30%"><a href="#"  id="order_pseudo"> Pseudo </a> </td>
	...
	<tr class="<?php  echo  $class_colorise?>">
		...
		if ($fiche->actif) {
			?>
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/point_vert.gif" alt="utilisateur actif" title="utilisateur actif" />
			<?php
		} else {
			?>
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/point_rouge.gif" alt="utilisateur actif" title="utilisateur actif" />
			<?php 
		} 
		?>
		</td>
		...
		<td style="text-align:left">
			<?php if ($fiche->email && $fiche->email != "") {?>
				<a href="mailto:<?php echo $fiche->email;?>"><?php echo $fiche->email;?></a>
			<?php } ?>
		</td>
		<td>
