...
<table  cellspacing="0" id="tableresult">
	...
	foreach ($fiches as $fiche) {
		...
		<tr class="<?php  echo  $class_colorise?>">
			<td>
				<a  href="#" id="pseudo_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>" style="display:block; width:100%;"> <?php echo nl2br(htmlentities($fiche->pseudo, ENT_QUOTES, "UTF-8"))?> / <?php echo $fiche->email;?>
				</a>
				<script type="text/javascript">
				Event.observe("pseudo_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt);page.verify('utilisateur_details','index.php#utilisateur_details.php?ref_user=<?php echo htmlentities($fiche->ref_user, ENT_QUOTES, "UTF-8")?>','true','_blank');}, false);
				</script>
			</td>
			<td>
			...
			<td style="text-align:center">
				...
				<script type="text/javascript">
				Event.observe("date_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt);page.verify('utilisateur_details','index.php#utilisateur_details.php?ref_user=<?php echo htmlentities($fiche->ref_user, ENT_QUOTES, "UTF-8")?>','true','_blank');}, false);
				</script>
			</td>
			<td  style=" text-align:center">
				...
				<script type="text/javascript">
				Event.observe("ip_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt);page.verify('utilisateur_details','index.php#utilisateur_details.php?ref_user=<?php echo htmlentities($fiche->ref_user, ENT_QUOTES, "UTF-8")?>','true','_blank');}, false);
				</script>
			</td>
		<td style="text-align:center"><?php if ($fiche->email && $fiche->email != "") {?>
				<a href="mailto:<?php echo $fiche->email;?>"> <img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/mail.gif" width="15" border="0" vspace="5"/> </a>
				<?php } ?>
		</td>
			<td style="text-align:center; vertical-align:middle">
				<a  href="#" id="voir_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>" style="display:block; width:100%; text-decoration:underline">Voir
				</a>
				<script type="text/javascript">
				Event.observe("voir_<?php echo htmlentities($fiche->id_log, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt);page.verify('utilisateur_details','index.php#utilisateur_details.php?ref_user=<?php echo htmlentities($fiche->ref_user, ENT_QUOTES, "UTF-8")?>','true','_blank');}, false);
				</script>
			</td>
		</tr>
		<?php
