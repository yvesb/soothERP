...
tableau_smenu[1] = Array('annuaire_gestion_admin_liste','annuaire_gestion_admin_liste.php' ,"true" ,"sub_content", "Liste des administrateurs");
update_menu_arbo();
</script>
<div class="emarge">
<p class="titre">Liste des administrateurs</p>

<div id="recherche" class="corps_moteur">
	<div id="recherche_simple" class="menu_link_affichage">
		<form action="#" id="form_recherche_simple" name="form_recherche_simple" method="GET" onsubmit="page.annuaire_recherche_admin(); return false;">
			<table style="width:97%">
				...
				<tr>
					...
					<input type="hidden" name="id_profil_s" id="id_profil_s" value="<?php echo $ADMIN_ID_PROFIL;?>" />
	...
	?>"   class="classinput_xsize"/></td>
				...
				<tr>
					<td></td>
					<td>&nbsp;</td>
					<td><input name="submit_s" type="image" onclick="$('page_to_show_s').value=1;" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-rechercher.gif" style="float:left" /></td>
					<td><!--<input type="image" name="res_s" id="res_s" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-annuler.gif"/>-->	</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td></td>
