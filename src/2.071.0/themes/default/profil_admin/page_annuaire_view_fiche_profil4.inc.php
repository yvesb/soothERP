...
if ($ce_client['id_edition_mode_favori'] == "")
        $ce_client['id_edition_mode_favori']   = 0; // si null on force à 0
...
if ($ce_client['id_tarif'] == "")
        $ce_client['id_tarif']                 = $categorie_client->id_tarif;
if ($ce_client['nom_commercial'] == "")
        $ce_client['nom_commercial']           = $categorie_client->nom_commercial;
if ($ce_client['facturation_periodique'] == "")
        $ce_client['facturation_periodique']   = $categorie_client->facturation_periodique;
if ($ce_client['delai_reglement'] == "")
        $ce_client['delai_reglement']          = $categorie_client->delai_reglement;
if ($ce_client['defaut_encours'] == "")
        $ce_client['defaut_encours']           = $categorie_client->defaut_encours;
if ($ce_client['prepaiement_ratio'] == "")
        $ce_client['prepaiement_ratio']        = $categorie_client->prepaiement_ratio;
if ($ce_client['prepaiement_type'] == "")
        $ce_client['prepaiement_type']         = $categorie_client->prepaiement_type;
if ($ce_client['id_reglement_mode_favori'] == "")
        $ce_client['id_reglement_mode_favori'] = $categorie_client->id_reglement_mode_favori;
if ($ce_client['id_cycle_relance'] == "")
        $ce_client['id_cycle_relance']         = $categorie_client->id_relance_modele;
if ($ce_client['id_edition_mode_favori'] == "")
        $ce_client['id_edition_mode_favori']   = $categorie_client->id_edition_mode_favori;
?>
...
foreach ($liste_categories_client as $liste_categorie_client) {
    ?>
                                            <option value="<?php echo $liste_categorie_client->id_client_categ; ?>" <?php if ($profils[$id_profil]->getId_client_categ() == $liste_categorie_client->id_client_categ) {
        echo 'selected="selected"';
        $id_client_categ = htmlentities($liste_categorie_client->lib_client_categ, ENT_QUOTES, "UTF-8");
    } ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select  id="type_client"  name="type_client" class="classinput_xsize">
                                        <option value="piste" <?php $type_client = "";
if ($profils[$id_profil]->getType_client() == "Piste") {
    echo 'selected="selected"';
    $type_client = "Piste";
} ?>>Piste</option>
                                        <option value="prospect" <?php if ($profils[$id_profil]->getType_client() == "Prospect") {
    echo 'selected="selected"';
    $type_client = $profils[$id_profil]->getType_client();
} ?>>Prospect</option>
                                        <option value="client" <?php if ($profils[$id_profil]->getType_client() == "Client") {
    echo 'selected="selected"';
    $type_client = $profils[$id_profil]->getType_client();
} ?>>Client</option>
                                        <option value="ancien client" <?php if ($profils[$id_profil]->getType_client() == "Ancien client") {
    echo 'selected="selected"';
    $type_client = $profils[$id_profil]->getType_client();
} ?>>Ancien client</option>
                                        <option value="Compte bloqué" <?php if ($profils[$id_profil]->getType_client() == "Compte bloqué") {
    echo 'selected="selected"';
    $type_client = $profils[$id_profil]->getType_client();
} ?>>Compte bloqué</option>
                                    </select>
                                </td>
                            </tr>

                            <tr <?php global $GESTION_COMM_COMMERCIAUX;
if (!$GESTION_COMM_COMMERCIAUX) {
    echo "style='display:none'";
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 20px">
                                                ...
                                                <script type="text/javascript">
                                                    Event.observe('ref_commercial_empty_s', 'click', function (evt) {
                                                        Event.stop(evt);
                        ...
                        <script type="text/javascript" language="javascript">
                            ...
                            Event.observe('valeurs_default_flag', 'click', function (evt) {
                                $("champs_par_defaut").toggle();
                            }, false);
                            Event.observe('libelle_valeurs_default_flag', 'click', function (evt) {
                                $("valeurs_default_flag").click();
                            }, false);
                            ...
                            Event.observe('img_facturation_periodique_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_facturation_periodique_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_facturation_periodique', 'facturation_periodique', 'img_facturation_periodique_cadenas-ouvert', 'img_facturation_periodique_cadenas-ferme', 'listereadonly', 'ferme', 'def_facturation_periodique', 'retour_value_facturation_periodique');
                                $('retour_value_facturation_periodique').value = $('def_facturation_periodique').value;
                            }, false);
                            Event.observe('facturation_periodique', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_facturation_periodique', 'facturation_periodique', 'img_facturation_periodique_cadenas-ouvert', 'img_facturation_periodique_cadenas-ferme', 'listereadonly', 'ouvert', 'def_facturation_periodique', 'retour_value_facturation_periodique');
                            }, false);
                            // mode édition favori
                            Event.observe('img_id_edition_mode_favori_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_id_edition_mode_favori_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_edition_mode_favori', 'id_edition_mode_favori', 'img_id_edition_mode_favori_cadenas-ouvert', 'img_id_edition_mode_favori_cadenas-ferme', 'listereadonly', 'ferme', 'def_id_edition_mode_favori', 'retour_value_id_edition_mode_favori');
                                $('retour_value_id_edition_mode_favori').value = $('def_id_edition_mode_favori').value;
                            }, false);
                            Event.observe('id_edition_mode_favori', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_edition_mode_favori', 'id_edition_mode_favori', 'img_id_edition_mode_favori_cadenas-ouvert', 'img_id_edition_mode_favori_cadenas-ferme', 'listereadonly', 'ouvert', 'def_id_edition_mode_favori', 'retour_value_id_edition_mode_favori');
                            }, false);
                            // délai de règlement
                            Event.observe('img_delai_reglement_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_delai_reglement_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ferme', 'def_delai_reglement', 'retour_value_delai_reglement');
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement_fdm', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ferme', 'def_delai_reglement_fdm', 'retour_value_delai_reglement_fdm');
                            ...
                            Event.observe('delai_reglement', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ouvert', 'def_delai_reglement', 'retour_value_delai_reglement');
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement_fdm', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ouvert', 'def_delai_reglement_fdm', 'retour_value_delai_reglement_fdm');
                            }, false);
                            Event.observe('delai_reglement', 'change', function (evt) {
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ouvert', 'def_delai_reglement', 'retour_value_delai_reglement');
                                if ($('delai_reglement').value == "")
                                    $('retour_value_delai_reglement').value = '0';
                            }, false);
                            Event.observe('delai_reglement_fdm', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ouvert', 'def_delai_reglement', 'retour_value_delai_reglement');
                                toggle_cadenas_et_valeurs('flg_delai_reglement', 'delai_reglement_fdm', 'img_delai_reglement_cadenas-ouvert', 'img_delai_reglement_cadenas-ferme', 'listereadonly', 'ouvert', 'def_delai_reglement_fdm', 'retour_value_delai_reglement_fdm');
                            }, false);
                            // règlement favori
                            Event.observe('img_id_reglement_mode_favori_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_id_reglement_mode_favori_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_reglement_mode_favori', 'id_reglement_mode_favori', 'img_id_reglement_mode_favori_cadenas-ouvert', 'img_id_reglement_mode_favori_cadenas-ferme', 'listereadonly', 'ferme', 'def_id_reglement_mode_favori', 'retour_value_id_reglement_mode_favori');
                                $('retour_value_id_reglement_mode_favori').value = $('def_id_reglement_mode_favori').value;
                            }, false);
                            Event.observe('id_reglement_mode_favori', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_reglement_mode_favori', 'id_reglement_mode_favori', 'img_id_reglement_mode_favori_cadenas-ouvert', 'img_id_reglement_mode_favori_cadenas-ferme', 'listereadonly', 'ouvert', 'def_id_reglement_mode_favori', 'retour_value_id_reglement_mode_favori');
                            }, false);
                            // cycle de relance
                            Event.observe('img_id_cycle_relance_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_id_cycle_relance_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_cycle_relance', 'id_cycle_relance', 'img_id_cycle_relance_cadenas-ouvert', 'img_id_cycle_relance_cadenas-ferme', 'listereadonly', 'ferme', 'def_id_cycle_relance', 'retour_value_id_cycle_relance');
                            }, false);
                            Event.observe('id_cycle_relance', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_cycle_relance', 'id_cycle_relance', 'img_id_cycle_relance_cadenas-ouvert', 'img_id_cycle_relance_cadenas-ferme', 'listereadonly', 'ouvert', 'def_id_cycle_relance', 'retour_value_id_cycle_relance');
                            }, false);
                            // Encours
                            Event.observe('img_encours_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_encours_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_encours', 'encours', 'img_encours_cadenas-ouvert', 'img_encours_cadenas-ferme', 'listereadonly', 'ferme', 'def_encours', 'retour_value_encours');
                                $('retour_value_encours').value = $('def_encours').value;
                            }, false);
                            Event.observe('encours', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_encours', 'encours', 'img_encours_cadenas-ouvert', 'img_encours_cadenas-ferme', 'listereadonly', 'ouvert', 'def_encours', 'retour_value_encours');
                            }, false);
                            Event.observe('encours', 'change', function (evt) {
                                toggle_cadenas_et_valeurs('flg_encours', 'encours', 'img_encours_cadenas-ouvert', 'img_encours_cadenas-ferme', 'listereadonly', 'ouvert', 'def_encours', 'retour_value_encours');
                            }, false);
                            // prepaiement et ratio
                            Event.observe('img_prepaiement_type_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_prepaiement_type_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_type', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ferme', 'def_prepaiement_type', 'retour_value_prepaiement_type');
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_ratio', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ferme', 'def_prepaiement_ratio', 'retour_value_prepaiement_ratio');
                            ...
                            Event.observe('prepaiement_type', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_type', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ouvert', 'def_prepaiement_type', 'retour_value_prepaiement_type');
                            ...
                            Event.observe('prepaiement_ratio', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_ratio', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ouvert', 'def_prepaiement_ratio', 'retour_value_prepaiement_ratio');
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_type', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ouvert', 'def_prepaiement_type', 'retour_value_prepaiement_type');
                            }, false);
                            Event.observe('prepaiement_ratio', 'change', function (evt) {
                                toggle_cadenas_et_valeurs('flg_prepaiement_type', 'prepaiement_ratio', 'img_prepaiement_type_cadenas-ouvert', 'img_prepaiement_type_cadenas-ferme', 'listereadonly', 'ouvert', 'def_prepaiement_ratio', 'retour_value_prepaiement_ratio');
                            }, false);
                            Event.observe("prepaiement_type", "change", function (evt) {
                            ...
                            // grille tarifs
                            Event.observe('img_id_tarif_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_id_tarif_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_tarif', 'id_tarif', 'img_id_tarif_cadenas-ouvert', 'img_id_tarif_cadenas-ferme', 'listereadonly', 'ferme', 'def_id_tarif', 'retour_value_id_tarif');
                                $('retour_value_id_tarif').value = $('def_id_tarif').value;
                            }, false);
                            Event.observe('id_tarif', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_id_tarif', 'id_tarif', 'img_id_tarif_cadenas-ouvert', 'img_id_tarif_cadenas-ferme', 'listereadonly', 'ouvert', 'def_id_tarif', 'retour_value_id_tarif');
                            }, false);
                            ...
                            // Afficher tarifs
                            Event.observe('img_app_tarifs_cadenas-ferme', 'click', function (evt) {
                            ...
                            Event.observe('img_app_tarifs_cadenas-ouvert', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_app_tarifs', 'app_tarifs', 'img_app_tarifs_cadenas-ouvert', 'img_app_tarifs_cadenas-ferme', 'listereadonly', 'ferme', 'def_app_tarifs', 'retour_value_app_tarifs');
                                $('retour_value_app_tarifs').value = $('def_app_tarifs').value;
                            }, false);
                            Event.observe('app_tarifs', 'click', function (evt) {
                                toggle_cadenas_et_valeurs('flg_app_tarifs', 'app_tarifs', 'img_app_tarifs_cadenas-ouvert', 'img_app_tarifs_cadenas-ferme', 'listereadonly', 'ouvert', 'def_app_tarifs', 'retour_value_app_tarifs');
                            }, false);
                            Event.observe('retour_value_app_tarifs', 'change', function (evt) {
                                if ($('retour_value_app_tarifs').value == 0)
                                    $('retour_value_app_tarifs').value = "";
                            }, false);
...
foreach ($FACTURES_PAR_MOIS as $key => $valeur) {
    ...
    <?php if ($profils[$id_profil]->getFactures_par_mois() == $key) {
        echo 'selected="selected"';
    } ?>
    <?php if ($ce_client['facturation_periodique'] == $categorie_client->facturation_periodique) { ?>
                                                <script type="text/javascript" language="javascript">
                            ...
                            <tr>
                                ...
                                <td colspan="4" style="width: 100%;">
                                    <select id="id_edition_mode_favori" class="classinput_xsize listereadonly"
                                           ...
                                           <?php } ?>
                                            >
                                        <option value="0" <?php if (($ce_client['id_edition_mode_favori'] == "") || ($ce_client['id_edition_mode_favori'] == 0)) {
                                               echo ' selected="selected"';
                                           } ?>>Non Défini</option>
<?php
...
<?php } else { ?>
                                    ...
                                    <input id="def_id_reglement_mode_favori" type="text"
                                           value="<?php if ($categorie_client->id_reglement_mode_favori == "") echo "0";
                                        else echo $categorie_client->id_reglement_mode_favori; ?>"
                                           style="display:none;">
                                    <input
...
<?php } else { ?>
                                    ...
                                    <input id="def_id_cycle_relance" type="text"
                                           value="<?php if ($categorie_client->id_relance_modele == "") echo "0";
                                           else echo $categorie_client->id_relance_modele; ?>"
                                           style="display:none;">
                                    <input
...
<?php if ($ce_client['id_tarif'] == $categorie_client->id_tarif) { ?> 
                                    ...
                                    <?php } ?>							
                                            >
                                        <option value="0" <?php if ($ce_client['id_tarif'] == "") {
                                        echo 'selected="selected"';
                                    } ?>>Automatique</option>
                                    <?php
...
if (is_null($categorie_client->id_tarif) || ($categorie_client->id_tarif == 0))
        echo "0";
else echo $categorie_client->id_tarif;
?>		
                                           " style="display:none;">
...
<?php if ($ce_client['app_tarifs'] == $profils[$id_profil]->getApp_Tarifs_Categorie()) { ?> 
                                    ...
                                    <?php } else { ?>
                                                class="classinput_xsize"
<?php } ?>>
                                        <option value="0" <?php if ($ce_client['app_tarifs'] == "") {
    echo 'selected="selected"';
} ?>>Automatique</option>
<?php
$liste_afficher_tarifs = array('HT', 'TTC');
...
?></a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" id="show4_delai_reglement" class="modif_input1">
                                <?php if (substr($profils[$id_profil]->getDelai_reglement(), -3) == "FDM") {
                                    echo htmlentities(substr($profils[$id_profil]->getDelai_reglement(), 0, -3), ENT_QUOTES, 'UTF-8') . " jour(s) Fin de mois";
                                } else {
                                    echo htmlentities($profils[$id_profil]->getDelai_reglement()). " jours(s)";
                                } ?></a>
                        </td>
                    </tr>	
...
?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" id="show4_encours" class="modif_input1"><?php if ($ce_client['defaut_encours'] >= 0) {
                                    echo $ce_client['defaut_encours'] . ' ' . $MONNAIE[1];
                                } ?></a>
                        </td>
                    </tr>
...
?>
                ...
                <script type="text/javascript" language="javascript">
                    ...
                    Event.observe("show4_delai_reglement", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'delai_reglement');
                    }, false);
                    Event.observe("show4_encours", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'encours');
                    }, false);
                    Event.observe("show4_facturation_periodique", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'facturation_periodique');
                    }, false);
                    // bac 2.0.54.0

                    Event.observe("show4_id_edition_mode_favori", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'id_edition_mode_favori');
                    }, false);
                    Event.observe("show4_id_reglement_mode_favori", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'id_reglement_mode_favori');
                    }, false);
                    Event.observe("show4_id_cycle_relance", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'id_reglement_mode_favori');
                    }, false);
                    Event.observe("show4_prepaiement_type", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'prepaiement_type');
                    }, false);
                    Event.observe("show4_nom_commercial", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'nom_commercial');
                    }, false);
                    // bac 2.0.54.0.

                    Event.observe("show4_app_tarifs", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'app_tarifs');
                    }, false);
                    Event.observe("show4_adresse_facturation_choisie", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'adresse_facturation_choisie');
                    }, false);
                    Event.observe("show4_adresse_livraison_choisie", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'adresse_livraison_choisie');
                    }, false);
                    Event.observe("show4_id_tarif", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'id_tarif');
                    }, false);
                    Event.observe("show4_id_client_categ", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'id_client_categ');
                    }, false);
                    Event.observe("show4_type_client", "click", function (evt) {
                        Event.stop(evt);
                        show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>', 'type_client');
                    }, false);
                //	Event.observe("show4_nom_commercial", "click",  function(evt){Event.stop(evt); show_edit_form('annu_edition_profil<?php echo $id_profil ?>', 'start_visible_profil<?php echo $id_profil ?>','nom_commercial');}, false);
                    ...
                    new Form.EventObserver('annu_edition_profil<?php echo $id_profil ?>', function (element, value) {
                        formChanged();
                    });

                    //masque numérique pour l'encours
                    Event.observe("encours", "blur", function (evt) {
                        nummask(evt, "0", "X");
                    }, false);
                    //masque numérique pour le délai de règlement
                    Event.observe("delai_reglement", "blur", function (evt) {
                        nummask(evt, "0", "X");
                    }, false);
                    //fonction de choix de adresses

                    //effet de survol sur le faux select adresse_livraison
                    Event.observe('adresse_livraison_choisie', 'mouseover', function () {
                        $("bt_adresse_livraison_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select_hover.gif";
                    }, false);
                    Event.observe('adresse_livraison_choisie', 'mousedown', function () {
                        $("bt_adresse_livraison_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select_down.gif";
                    }, false);
                    Event.observe('adresse_livraison_choisie', 'mouseup', function () {
                        $("bt_adresse_livraison_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select.gif";
                    }, false);
                    Event.observe('adresse_livraison_choisie', 'mouseout', function () {
                        $("bt_adresse_livraison_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select.gif";
                    }, false);

                    //effet de survol sur le faux select adresse_facturation
                    Event.observe('adresse_facturation_choisie', 'mouseover', function () {
                        $("bt_adresse_facturation_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select_hover.gif";
                    }, false);
                    Event.observe('adresse_facturation_choisie', 'mousedown', function () {
                        $("bt_adresse_facturation_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select_down.gif";
                    }, false);
                    Event.observe('adresse_facturation_choisie', 'mouseup', function () {
                        $("bt_adresse_facturation_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select.gif";
                    }, false);
                    Event.observe('adresse_facturation_choisie', 'mouseout', function () {
                        $("bt_adresse_facturation_choisie").src = "<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/bt-arrow_select.gif";
                    }, false);

                    //affichage des choix
                    Event.observe('adresse_livraison_choisie', 'click', function (evt) {
                        Event.stop(evt);
                        start_adresse("<?php echo $contact->getRef_contact() ?>", "lib_adresse_livraison_choisie", "ref_adr_livraison", "choix_liste_choix_adresse_livraison", "iframe_liste_choix_adresse_livraison", "annuaire_liste_choix_adresse.php");
                    }, false);

                    Event.observe('adresse_facturation_choisie', 'click', function (evt) {
                        Event.stop(evt);
                        start_adresse("<?php echo $contact->getRef_contact() ?>", "lib_adresse_facturation_choisie", "ref_adr_facturation", "choix_liste_choix_adresse_facturation", "iframe_liste_choix_adresse_facturation", "annuaire_liste_choix_adresse.php");
                    }, false);
