								...
								if (key($list_art_categ) != "") {
									if ($art_categ->indentation < current($list_art_categ)->indentation) {
										?><a href="#" id="link_div_art_categ_<?php echo $art_categ->ref_art_categ ?>">
																...
																<script type="text/javascript">
																	Event.observe("link_div_art_categ_<?php echo $art_categ->ref_art_categ ?>", "click", function (evt) {
																		Event.stop(evt);
																		Element.toggle('div_<?php echo $art_categ->ref_art_categ ?>');
																		Element.toggle('extend_<?php echo $art_categ->ref_art_categ ?>');
																		Element.toggle('collapse_<?php echo $art_categ->ref_art_categ ?>');
																	}, false);
																</script>
					<?php
				} else {
							...
							<td width="180px">
								<div style="display:block; width:180px; text-align: center">
									...
									<span style="text-align: center;">
										<input id="bt_mod_catalogue_<?php echo $catalogue_client->id_catalogue_client; ?>" type="image" name="bt_mod_catalogue_<?php echo $catalogue_client->id_catalogue_client; ?>" src="../../themes/default/images/bt-valider.gif"/>
									</span>
									<script type="text/javascript">
...
foreach ($list_art_categ as $art_categ) {
	?>
			Event.observe('tr_<?php echo ($art_categ->ref_art_categ) ?>', 'mouseover', function () {
				changeclassname('tr_<?php echo ($art_categ->ref_art_categ) ?>', 'list_art_categs_hover');
			}, false);

			Event.observe('tr_<?php echo ($art_categ->ref_art_categ) ?>', 'mouseout', function () {
				changeclassname('tr_<?php echo ($art_categ->ref_art_categ) ?>', 'list_art_categs');
			}, false);
