...
<tr class="<?php  echo  $class_colorise?>">
	...
	Event.observe("link_ref_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	<td>
	...
	<script type="text/javascript">
	Event.observe("link_type_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	...
	<script type="text/javascript">
	Event.observe("link_etat_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	<td style="text-align:left">
		<a  href="#" id="link_contact_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>" style="display:block; width:100%" alt="<?php	if ($fiche->nom_contact) { echo htmlentities($fiche->nom_contact, ENT_QUOTES, "UTF-8"); }?>" title="<?php	if ($fiche->nom_contact) { echo htmlentities($fiche->nom_contact, ENT_QUOTES, "UTF-8"); }?>">
		<?php	if ($fiche->nom_contact) { echo htmlentities(substr($fiche->nom_contact, 0, 38), ENT_QUOTES, "UTF-8"); }?>&nbsp;
		</a>
	<script type="text/javascript">
	Event.observe("link_contact_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	...
	<script type="text/javascript">
	Event.observe("link_montant_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	<td style="text-align:center">
	...
	<script type="text/javascript">
	Event.observe("link_date_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	...
	<script type="text/javascript">
	Event.observe("link_edit_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>", "click",  function(evt){Event.stop(evt); page.verify('documents_edition','<?php echo $DIR.$_SESSION['profils'][3]->getDir_profil ();?>index.php#'+escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8")?>'),'true','_blank');}, false);
	</script>
	</td>
	<td style="vertical-align:middle; text-align:center">
