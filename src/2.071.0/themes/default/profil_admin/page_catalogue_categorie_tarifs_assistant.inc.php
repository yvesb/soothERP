...
<a href="#" id="link_close_pop_up_assistant_tarif" style="float:right"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/supprime.gif" border="0"></a>
<script type="text/javascript">
Event.observe("link_close_pop_up_assistant_tarif", "click",  function(evt){Event.stop(evt); reset_assistant_tarif('pop_up_assistant_tarif', 'pop_up_assistant_tarif_iframe', 'form_assistant_tarif', 'assistant_form_step2', 'assistant_form_step3', 'assistant_form_step4');}, false);
</script>
<?php if ($USE_FORMULES) {?>
...
<?php } ?>
	...
	<form id="form_assistant_tarif" name="form_assistant_tarif" method="post" action="catalogue_categorie_tarifs_formule.php" target="formFrame">
	
	<input name="assistant_indice_qte"  id="assistant_indice_qte" type="hidden" value="">
	<input name="assistant_id_tarif"  id="assistant_id_tarif" type="hidden" value="">
	<input name="assistant_art_categ"  id="assistant_art_categ" type="hidden" value="">
	<input name="assistant_cellule"  id="assistant_cellule" type="hidden" value="">
	<input name="new_formule"  id="new_formule" type="hidden" value="">
	<input name="old_formule"  id="old_formule" type="hidden" value="">
	<?php if ($USE_FORMULES) {?>
