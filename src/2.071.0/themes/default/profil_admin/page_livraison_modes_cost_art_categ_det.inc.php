...
foreach ($fiche->livraisons_tarifs as $cost) {
	...
	<a href="#" id="link_livraison_modes_cost_sup_<?php echo $i;?>_<?php echo str_replace(".", "_", $fiche->ref_art_categ); ?>" style="float:right;" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/supprime.gif" border="0"></a>
	<script type="text/javascript">
...
<div id="add_cost_liv_mode_liv_<?php echo str_replace(".", "_", $fiche->ref_art_categ); ?>" style="cursor:pointer;<?php if (!count($fiche->livraisons_tarifs)) { ?>display:none<?php } ?>"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/ajouter.gif" /> <span style="font-weight:bolder">Ajouter un palier</span></div>
					
<div style="text-align:center; "><br />

				<input name="valider_cost_<?php echo str_replace(".", "_", $fiche->ref_art_categ); ?>" id="valider_cost_<?php echo str_replace(".", "_", $fiche->ref_art_categ); ?>" type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-valider.gif" />
				</div>
</form>
