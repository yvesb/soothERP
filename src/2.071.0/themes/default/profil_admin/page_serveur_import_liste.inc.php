		...
		<tr class="smallheight">
			<td>
				...
				Event.observe("verifier_serveur", "click",  function(evt){
					Event.stop(evt); 
					url_to_send = $("url_serveur_import").value+"<?php echo $ECHANGE_DIR;?>/serveur_export_partage_liste.php?url="+document.URL.replace("/core/profil_admin/serveur_import_liste.php", "");
