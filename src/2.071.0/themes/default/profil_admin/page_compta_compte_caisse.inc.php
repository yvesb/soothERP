			...
			<td style="width:95%">
				...
				<table>
					...
					<tr>
						...
						<td style="text-align:center">
						<select id="id_compte_tpe" name="id_compte_tpe"  class="classinput_xsize" >
							<option value="">Pas de TPE</option>
							<?php 
		...
		foreach ($comptes_caisses as $compte_caisse) {
			...
			<div class="caract_table">
				...
				<tr>
					<td style="width:95%">
						...
						<table>
							...
							<tr>
								...
								<td style="text-align:center">
								<select id="id_compte_tpe_<?php echo $compte_caisse->id_compte_caisse;?>" name="id_compte_tpe_<?php echo $compte_caisse->id_compte_caisse;?>"  class="classinput_xsize" >
									<option value="">Pas de TPE</option>
									<?php 
									foreach ($comptes_tpes as $compte_tpe) {
										?>
							...
							<input type="checkbox" id="actif_<?php echo $compte_caisse->id_compte_caisse;?>" name="actif_<?php echo $compte_caisse->id_compte_caisse;?>" value="1" <?php if ($compte_caisse->actif) {echo 'checked="checked"';};?>/>
								...
								<td style="text-align:center">
						<input name="modifier_<?php echo $compte_caisse->id_compte_caisse;?>" id="modifier_<?php echo $compte_caisse->id_compte_caisse;?>" type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-modifier.gif" />
								</td>
							</tr>
						</table>
						</form>
					...
					<a href="#" id="link_compta_compte_caisse_sup_<?php echo $compte_caisse->id_compte_caisse; ?>"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/supprime.gif" border="0"></a>
					<script type="text/javascript">
					...
					<table cellspacing="0">
						<tr>
							<td>
								...
								<form action="compta_compte_caisse_ordre.php" method="post" id="compta_compte_caisse_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" name="compta_compte_caisse_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" target="formFrame">
									...
									<input name="modifier_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" id="modifier_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/up.gif">
								</form>
								<?php
								} else {
								?>
						...
						<tr>
							...
							<form action="compta_compte_caisse_ordre.php" method="post" id="compta_compte_caisse_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" name="compta_compte_caisse_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" target="formFrame">
									...
									<input name="modifier_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" id="modifier_ordre_<?php echo $compte_caisse->id_compte_caisse; ?>" type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/down.gif">
								</form>
								<?php
								} else {
								?>
