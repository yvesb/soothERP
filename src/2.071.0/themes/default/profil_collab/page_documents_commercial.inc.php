...
<?php if ($_SESSION['user']->check_permission("17")) { ?>
            <br />
    ...
    <?php echo Helper::createInputAnnu("attrib_ref_commercial_$i", "", array("filtres" => "lib=Commercial")); ?>
                                    ...
                                    <td style="width:85px">
                                        <input type="text" size="5" id="part_<?php echo $i; ?>" name="part_<?php echo $i; ?>" value="<?php if (!$i) {
                                        echo "100";
                                    } else {
                                        echo "0";
                    ...
                    <span style="display:" id="unshow_add_comm">
                        ...
                        <span class="comm_val">
                            <span style="font-weight:bolder; text-decoration:underline; cursor:pointer" id="ajouter_commercial_part">Ajouter un commercial</span>
    ...
    for ($j = 0; $j <= $i; $j++) {
        ?>
                                Event.observe('part_<?php echo $j; ?>', "blur", function (evt) {
                                    nummask(evt, 0, "X");
                                    Event.stop(evt);
