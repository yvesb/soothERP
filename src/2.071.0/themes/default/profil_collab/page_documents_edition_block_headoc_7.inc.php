		...
		<td colspan="3">
					...
					<td valign="top">
									<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
										<tr>
											...
											<?php
											if ($document->getId_etat_doc () == 29) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt_blf_reception.gif" id="bon_recept_pret" style="cursor:pointer"/>
			...
			?>
				...
				if ($document->getId_etat_doc () == 29) {
					?>
					//devis pret
					Event.observe("bon_recept_pret", "click", function(evt){Event.stop(evt); maj_etat_doc (31);
						$("bon_recept_pret").hide(); }, false);
				<?php
				}
				?>
