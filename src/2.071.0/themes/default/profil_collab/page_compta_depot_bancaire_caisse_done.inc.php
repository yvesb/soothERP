...
<div class="titre" style="width:60%; padding-left:140px">Remise en banque depuis  <?php echo htmlentities($compte_caisse->getLib_caisse(), ENT_QUOTES, "UTF-8"); ?> effectuée
</div>
...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
	...
	<span id="print_rapport" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" />Impression de la remise en banque</span><br />
