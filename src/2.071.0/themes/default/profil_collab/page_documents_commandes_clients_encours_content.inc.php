...
foreach ($commandes as $commande) {
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="document_box_head">
		<tr>
			...
			<a href="#" id ="<?php echo htmlentities($stock_vu."_".$commande->ref_doc, ENT_QUOTES, "UTF-8");?>" style="text-decoration:none; color:#000000">
			...
			<a href="#" id ="<?php echo htmlentities($stock_vu."_".$commande->ref_doc, ENT_QUOTES, "UTF-8");?>ctc" style="text-decoration:none; color:#000000"><?php echo ($commande->nom_contact);?>
			</a>
			<script type="text/javascript">
			...
			<script type="text/javascript">
				...
				$("commande_genere_livraison_<?php echo htmlentities($stock_vu."_".$commande->ref_doc, ENT_QUOTES, "UTF-8");?>").hide();
				}, false);
			</script>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="<?php  echo  $class_colorise?>">
				<tr>
					...
					<td style="width:110px" class="document_border_right">
						...
						<a href="#" id="<?php echo htmlentities($stock_vu."_".$commande->ref_doc, ENT_QUOTES, "UTF-8");?><?php echo htmlentities($contenu->ref_article, ENT_QUOTES, "UTF-8")?>" style="text-decoration:none; color:#000000">
