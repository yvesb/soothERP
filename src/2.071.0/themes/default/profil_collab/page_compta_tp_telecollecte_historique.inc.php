...
<div class="titre" id="titre_crea_art" style="width:60%; padding-left:140px">Historique des télécollectes <?php echo htmlentities($compte_tp->getLib_tp(), ENT_QUOTES, "UTF-8"); ?>
</div>
			...
			<td colspan="2" style="width:90%">
				...
				<table width="75%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt_ok.gif" id="reload_etat_tp" style="cursor:pointer;"/></td>
						</tr>
				</table>
				</div>
				<br />
