...
?>
<div class="emarge">
<p class="titre">Recherche des rappels d'événements </p>

<div id="recherche" class="corps_moteur">
	<div id="recherche_simple" class="menu_link_affichage">
		<form action="#" id="form_recherche_simple" name="form_recherche_simple" method="GET" onsubmit="page.evenements_rappels_recherche(); return false;">
...
<div id="resultat_evenements_rappels"></div>
