...
Event.observe("menu_1", "click",  function(evt){Event.stop(evt); view_menu_1('recherche', 'menu_1', array_menu_d_user_contact );}, false);
Event.observe("menu_2", "click",  function(evt){Event.stop(evt); view_menu_1('infogene', 'menu_2', array_menu_d_user_contact );
setheight_utilisateur_detail();}, false);
