...
<br /><br />
					...
					<div style="text-align:center">
						...
						<span id="telecollecte_tp" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_bleue.gif"  style="padding-right:10px; " vspace="3" /> Télécollecte</span>
