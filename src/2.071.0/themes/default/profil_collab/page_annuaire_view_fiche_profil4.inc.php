		...
		<div class="reduce_in_edit_mode" id="champs_par_defaut" style="display: none">
			...
			<table class="minimizetable" id="table_champs_par_defaut"
				...
				<tr>
					...
					<td>
						<img id="img_prepaiement_type_cadenas-ferme" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/cadenas-ferme.png" width="12px" height="12px" style="float: center; cursor: pointer">
						<img id="img_prepaiement_type_cadenas-ouvert" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/cadenas-ouvert.png" width="12px" height="12px" style="float: center; cursor: pointer; display: none;">
