				...
				case "1":{ //impression
					...
					<td style="padding-right:10px">
						<a href="courriers_editing_print.php<?php echo $params_p ?>" target="mainediting" >
							<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-imprimer.gif" alt="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" title="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" />
						</a>
					</td>
					<?php break;}
				...
				case "2":{ //envois par email
					...
					<td style="padding-right:10px">
						<a href='javascript:PopupCentrer("courriers_editing_email.php<?php echo $params_p; ?>",800,450,"menubar=no,statusbar=no,scrollbars=yes,resizable=yes")'>
							<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-email.gif" alt="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" title="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" />
						</a>
					</td>
				<?php break;}
				...
				case "3": { //envois par FAX
					...
					<td style="padding-right:10px">
						<a href='javascript:PopupCentrer("courriers_editing_fax.php<?php echo $params_p; ?>",500,350,"menubar=no,statusbar=no,scrollbars=auto")'>
							<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-fax.gif" alt="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" title="<?php echo  htmlentities($edition_mode->lib_edition_mode, ENT_QUOTES, "UTF-8");?>" />
						</a>
					</td>
				<?php	break; }
			}
