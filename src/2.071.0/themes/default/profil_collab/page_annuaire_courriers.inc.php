...
<div style=" text-align:left; padding:0 20px">
	...
	<table style="width:100%">
		<tr class="smallheight">
			...
			-->
			<td style="width:100%"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
		</tr>
		<tr>
			<td>
				<?php
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
					<tr class="smallheight" style="">
						<td id="12"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
						<td id="14" style="width:100px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
						<td id="11" style="width:85px; "><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
						<td id="13" style="width:120px; "><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
						<td id="15" style="width:18px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
					</tr>
					<tr style="text-align:left; vertical-align:top; color:#00336c; font-weight:bolder">
						...
						<td id="25"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" width="25px"/></td>
					</tr>
				</table>
				...
				<div class="art_new_info" >
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
						<tr class="smallheight" style="">
							<td id="32" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
							<td id="34" style="width:100px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
							<td id="31" style="width:85px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
							<td id="33" style="width:120px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
							<td id="35" style="width:18px;"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif" height="1" id="imgsizeform"/></td>
						</tr>
						<tr style="cursor:pointer; color:#002673">
							...
							<a href="courrier_editing.php?id_courrier=<?php echo $courrier->getId_courrier()?>" target="edition" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-pdf.gif" alt="PDF" title="PDF"/></a>
