...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="border-bottom:1px solid #999999">
		<tr>
			...
			<div style="width:35px">
				<a href="documents_editing.php?ref_doc=<?php echo $histo_vente->getRef_doc()?>" target="edition" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-pdf.gif" alt="pdf" title="pdf"/></a>
			</div>
			</td>
		</tr>
		<?php
