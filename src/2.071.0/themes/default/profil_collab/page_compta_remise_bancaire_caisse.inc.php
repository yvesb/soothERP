		...
		<div class="emarge"><br />
			...
			<table width="780" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-espece.gif" id="line0_esp"/>
					<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-cheque.gif" id="line0_chq" style="display:none"/>			</td>
