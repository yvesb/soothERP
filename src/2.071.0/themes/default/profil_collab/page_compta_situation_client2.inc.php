...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF">
		...
		<tr>
			<td style="text-align:left;" valign="top">
				...
				<span class="titre_smenu_page" id="compta_livraisons_client_nonfacturees" style="padding-left:100px;cursor:pointer"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce.png" align="absmiddle" />&nbsp;&nbsp;Facturer les bons de livraisons (<!--ici le nombre-->)</span><br /><br /><br />
				...
				<span class="titre_smenu_page" id="compta_factures_client_non_editees" style="padding-left:100px;cursor:pointer"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce.png" align="absmiddle" />&nbsp;&nbsp;Factures non éditées, procéder à l'envoi initial (<?php echo $nbre_non_editee;?>)</span><br /><br />
				
				<span class="titre_smenu_page" id="compta_factures_client_a_relancer" style="padding-left:100px;cursor:pointer"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce.png" align="absmiddle" />&nbsp;&nbsp;Factures à relancer (<?php echo $nbre_relance;?>)</span><br /><br />


				<span class="titre_smenu_page" id="compta_factures_client_contentieux" style="padding-left:100px;cursor:pointer"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce.png" align="absmiddle" />&nbsp;&nbsp;Factures en contentieux (<?php echo $nbre_contentieux;?>)</span><br /><br />
