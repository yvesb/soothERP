	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<a href="#" id="link_art_edition_composant_<?php echo $_REQUEST['niveau']?>_<?php echo $_REQUEST['serie_composant']?>">Ajouter un composant</a>
				...
				Event.observe("link_art_edition_composant_<?php echo $_REQUEST['niveau']?>_<?php echo $_REQUEST['serie_composant']?>", "click",  function(evt){Event.stop(evt); show_mini_moteur_articles ('art_add_composant', '<?php echo $_REQUEST['niveau']?>, <?php echo $_REQUEST['serie_composant']?>');}, false);
				</script>
