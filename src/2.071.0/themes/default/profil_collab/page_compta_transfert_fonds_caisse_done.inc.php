...
<div class="titre" style="width:60%; padding-left:140px">Transfert de fonds depuis <?php echo htmlentities($compte_caisse->getLib_caisse(), ENT_QUOTES, "UTF-8"); ?> effectué
</div>
...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
	...
	<span id="link_retour_caisse" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" /> Retour au Tableau de bord</span><br />
<br />

	<span id="print_rapport" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" />Impression du rapport de transfert</span><br />
...
page.verify("compta_transfert_caisse_imprimer", "compta_transfert_caisse_imprimer.php?id_caisse=<?php echo $_REQUEST["id_caisse"];?>&id_compte_caisse_transfert=<?php echo $_REQUEST["id_compte_caisse_transfert"];?>", "true", "_blank");
}, false);
