...
<table class="minimizetable">
	<tr>
		<td class="size_strict"><img
			src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/blank.gif"
	...
	<tr>
		<td class="size_strict"><span class="labelled_ralonger">Cat&eacute;gorie
		de client:</span></td>
		<td><select id="id_client_categ" name="id_client_categ"
	...
	<tr>
		<td class="size_strict"><span class="labelled_ralonger">Etat du
		compte:</span></td>
		<td><select id="type_client" name="type_client"
			class="classinput_xsize">
	...
	<tr <?php global $GESTION_COMM_COMMERCIAUX;if (!$GESTION_COMM_COMMERCIAUX){ echo "style='display:none'";} ?>>
        ...
        <tr>
		<td class="size_strict"><span class="labelled_ralonger">Adresse de
		Livraison:</span></td>
		<td>
		<div
			style="position: relative; top: 0px; left: 0px; width: 100%; height: 0px;">
		<iframe id="iframe_liste_choix_adresse_livraison" frameborder="0"
			scrolling="no" src="about:_blank"
			class="choix_liste_choix_coordonnee" style="display: none"></iframe>
		<div id="choix_liste_choix_adresse_livraison"
			class="choix_liste_choix_coordonnee" style="display: none"></div>
		</div>
		<div id="adresse_livraison_choisie" class="simule_champs"
			style="width: 99%; cursor: default;"><img
			src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-arrow_select.gif"
			style="float: right" id="bt_adresse_livraison_choisie"> <span
			id="lib_adresse_livraison_choisie"></span></div>
		<input name="ref_adr_livraison" id="ref_adr_livraison" type="hidden"
			class="classinput_xsize" value="" /></td>
	</tr>
	<tr>
		<td class="size_strict"><span class="labelled_ralonger">Adresse de
		Facturation:</span></td>
		...
		<div
			style="position: relative; top: 0px; left: 0px; width: 100%; height: 0px;">
		<iframe id="iframe_liste_choix_adresse_facturation" frameborder="0"
			scrolling="no" src="about:_blank"
			class="choix_liste_choix_coordonnee" style="display: none"></iframe>
		<div id="choix_liste_choix_adresse_facturation"
			class="choix_liste_choix_coordonnee" style="display: none"></div>
		</div>
		<div id="adresse_facturation_choisie" class="simule_champs"
			style="width: 99%; cursor: default;"><img
			src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-arrow_select.gif"
			/ style="float: right" id="bt_adresse_facturation_choisie"> <span
			id="lib_adresse_facturation_choisie"></span></div>
		<input name="ref_adr_facturation" id="ref_adr_facturation"
			type="hidden" class="classinput_xsize" value="" /></td>
	</tr>
	...
	<!-- 	bac 08/04/2010 version 2.051
			ajout des cadenas ( ouvert, fermés ), checkbox lié au cadenas,
			cadenas lockés flag associé coché, délocké, flag décoché
			. zone cachée reprennant les valeurs par défaut de la catégorie client
			. autre zone cachée contenant la valeur (clef) de retour 
			zone paramètres par défaut rendus visibles au clic 
	-->
	<script type="text/javascript" language="javascript">
	...
	<tr>
		...
		<td colspan="2"><!-- valeurs par défaut catégorie client délai de règlement -->
			...
			<input type="checkbox" id="delai_reglement_fdm" value="1"
				...
				?>
                                style="cursor:pointer"> Fin de mois </input>
<!--                        valeurs par défaut catégorie client delai règlement fin de mois -->
	...
	<tr>
		...
		<td>
			...
			<input id="def_prepaiement_type" type="text" class="classinput_lsize listereadonly"
				value="<?php echo $prepaiement_type; ?>" style="display:none">
