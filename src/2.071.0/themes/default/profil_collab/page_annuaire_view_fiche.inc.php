    ...
    <div id="contactview_menu" class="menu">
        <ul id="menu_ul">
            ...
            <div style="float:right; width:200px">
                ...
                <script type="text/javascript">
                    Event.observe("communication", "click", function (evt) {
                        Event.stop(evt);
                        $("tool_uitem_menu").hide();
                        if ($("tool_uitem_menu_profils")) {
                            $("tool_uitem_menu_profils").hide();
            ...
            <li><a href="#" id="contactview_menu_a"  class="menu_select">Informations g&eacute;n&eacute;rales</a>
                <script type="text/javascript">
                    Event.observe("contactview_menu_a", "click", function (evt) {
                        ...
                        view_menu_1('contactview_general', 'contactview_menu_a', array_menu_v_contact);
            ...
            ?>
            <div style="width:1px" id="last_item_menu"></div>
        </ul>
    </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="roundedtable"><tr>
                                            <td>
                                                <table class="minimizetable" id="nom_lib" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="#" id="link_show_nom" class="modif_textarea3"><?php echo nl2br(($contact->getNom())); ?></a>
                                                            <script type="text/javascript">
                                                                Event.observe("link_show_nom", "click", function (evt) {
                                                                    Event.stop(evt);
                                                                    show_edit_form('nom_mask', 'nom_lib', 'nom');
                                                                }, false);
                                                            </script>
                                                        ...
                                                        <td><a href="#" id="line_siret4" class="modif_textarea3" style="display:none"><?php echo $contact->getSiret(); ?></a>
                                                            <script type="text/javascript">
                                                                Event.observe("line_siret4", "click", function (evt) {
                                                                    Event.stop(evt);
                                                                    show_edit_form('nom_mask', 'nom_lib', 'siret');
                                                                }, false);
                                                            </script>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <script type="text/javascript">
                                                                Event.observe("link_show_id_categ", "click", function (evt) {
                                                                    Event.stop(evt);
                                                                    show_edit_form('nom_mask', 'nom_lib', 'id_categorie');
                                                                }, false);
                                                            </script>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <script type="text/javascript">
                                                                Event.observe("link_show_civili", "click", function (evt) {
                                                                    Event.stop(evt);
                                                                    show_edit_form('nom_mask', 'nom_lib', 'civilite');
                                                                }, false);
                                                            </script>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table class="minimizetable" id="nom_mask" style="display:none;" cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr>
                                                        <td><span class="labelled" style="width:85px">Nom:</span></td>
                                                        <td><textarea id="nom" name="nom"  rows="<?php if (stristr($_SERVER["HTTP_USER_AGENT"], "firefox")) {
                echo "1";
            } else {
                echo "2";
            } ?>" class="classinput_xsize"><?php echo $contact->getNom() ?></textarea></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select id="id_categorie" name="id_categorie" class="classinput_xsize">
                                                                        <?php foreach ($ANNUAIRE_CATEGORIES as
                                                                                    $categorie) {
                                                                            ?>
...
?>
                                ...
                                <div id="liste_document_client" style="display:<?php if (!isset($profils[$CLIENT_ID_PROFIL])) {
    echo "none";
} ?> ">
...
<?php } ?> 
                                ...
                                <div id="liste_document_fournisseur" style="display:<?php if (!isset($profils[$FOURNISSEUR_ID_PROFIL])) {
                                        echo "none";
                                    } ?> ">
...
if (count($contact_last_docs)) {
    ...
    foreach ($contact_last_docs as $contact_last_doc) {
        ...
        <?php echo (price_format($contact_last_doc->montant_ttc)) . " " . $MONNAIE[1]; ?>
                                            ...
                                            <script type="text/javascript">
                                                Event.observe('open_doc_<?php echo ($contact_last_doc->ref_doc); ?>', "click", function (evt) {
                                                    open_doc("<?php echo ($contact_last_doc->ref_doc); ?>");
                                                });
                                                Event.observe('open_doc_1_<?php echo ($contact_last_doc->ref_doc); ?>', "click", function (evt) {
                                                    open_doc("<?php echo ($contact_last_doc->ref_doc); ?>");
                                                });
                                                Event.observe('open_doc_2_<?php echo ($contact_last_doc->ref_doc); ?>', "click", function (evt) {
                                                    open_doc("<?php echo ($contact_last_doc->ref_doc); ?>");
                                                });
                                                Event.observe('open_doc_3_<?php echo ($contact_last_doc->ref_doc); ?>', "click", function (evt) {
                                                    open_doc("<?php echo ($contact_last_doc->ref_doc); ?>");
                                                });
                                            </script>
        <?php
...
?>
                        ...
                        <div id="menu_caiu" class="menu_sec" style="float:left; width:100%">
                            ...
                            <script type="text/javascript">
                                Event.observe("select_menu_caiu1", "click", function (evt) {
                                    Event.stop(evt);
                                    view_menu_sec('annu_nvlfiche_coord', 'select_menu_caiu1', 'annu_nvlfiche_adresse', 'select_menu_caiu2', 'annu_nvlfiche_internet', 'select_menu_caiu3');
                                }, false);
                                Event.observe("select_menu_caiu2", "click", function (evt) {
                                    Event.stop(evt);
                                    view_menu_sec('annu_nvlfiche_adresse', 'select_menu_caiu2', 'annu_nvlfiche_coord', 'select_menu_caiu1', 'annu_nvlfiche_internet', 'select_menu_caiu3');
                                }, false);
                                Event.observe("select_menu_caiu3", "click", function (evt) {
                                    Event.stop(evt);
                                    view_menu_sec('annu_nvlfiche_internet', 'select_menu_caiu3', 'annu_nvlfiche_adresse', 'select_menu_caiu2', 'annu_nvlfiche_coord', 'select_menu_caiu1');
                                }, false);
                            </script>
                        </div>
                        <br />
                                        ...
                                        foreach ($coordonnees as $coordonnee) {
                                            ...
                                            if (count($droitsVoirCoord) > 0) {
                                                if ($coordonnee->getType() != "" && $coordonnee->getType() != 0 && $droitsVoirCoord[0] != "ALL") {
                                                    if (!in_array($coordonnee->getType(), $droitsVoirCoord)) {
                                                        $droitCoord = false;
                                                    }
                                                }
                                                if ($droitCoord) {
...
?>
                                ...
                                <script type="text/javascript">
                                    Event.observe("link_add_new_coord", "click", function (evt) {
                                        Event.stop(evt);
                                        createtagmobil('coordlist', 'li', 'coordcontent', 'edition_coordonnee_nouvelle');
                                    }, false);
                                </script>
                            </div>
                                    ...
                                    foreach ($adresses as $adresse) {
                                        ...
                                        if (count($droitsVoirAdresses) > 0) {
                                            if ($adresse->getType() != "" && $adresse->getType() != 0 && $droitsVoirAdresses[0] != "ALL") {
                                                if (!in_array($adresse->getType(), $droitsVoirAdresses)) {
                                                    $droitAdresse = false;
                                                }
                                            }
                                            if ($droitAdresse) {
...
?>
                                ...
                                <script type="text/javascript">
                                    Event.observe("link_add_new_adress", "click", function (evt) {
                                        Event.stop(evt);
                                        createtagmobil('adresslist', 'li', 'adressecontent', 'edition_adresse_nouvelle');
                                    }, false);
                                </script>
                            </div>
                                    ...
                                    foreach ($sites_web as $site_web) {
                                        ...
                                        if (count($droitsVoirsite) > 0) {
                                            if ($site_web->getType() != "" && $site_web->getType() != 0 && $droitsVoirsite[0] != "ALL") {
                                                if (!in_array($site_web->getType(), $droitsVoirsite)) {
                                                    $droitSite = false;
                                                }
                                            }
                                            if ($droitSite) {
...
?>
                                ...
                                <script type="text/javascript">
                                    Event.observe("link_add_new_site", "click", function (evt) {
                                        Event.stop(evt);
                                        createtagmobil('sitelist', 'li', 'sitecontent', 'edition_site_nouvelle');
                                    }, false);
                                </script>
                            </div>
                        </div>
                            ...
                            <div id="annu_nvlfiche_user">
                                ...
                                <?php
                                   foreach ($users as $user) {
                                       ...
                                       if (!$_SESSION['user']->check_permission("7") && isset($profils[$COLLAB_ID_PROFIL])) {
                                           continue;
                                       }
                                       //permission (8) Gestion des Administrateurs
                                       if (!$_SESSION['user']->check_permission("8") && isset($profils[$ADMIN_ID_PROFIL])) {
                                           continue;
                                       }
                                       ?>
                                ...
                                <a href="#" class="ajout"  id="link_add_new_user" <?php
                                    ...
                                    ?>>Ajouter un nouvel utilisateur</a><br/>
    ...
    if ($coordonnee->getEmail()) {
        ?>
            ...
            ?>
                                ...
                                <script type="text/javascript">
                                    Event.observe("link_add_new_user", "click", function (evt) {
                                        Event.stop(evt);
                                        createtagmobil('userlist', 'li', 'usercontent', 'edition_user_nouvelle');
                                    }, false);
                                </script>
...
if (isset($profils[$FOURNISSEUR_ID_PROFIL])) {
    ...
    <?php if ($profils[$FOURNISSEUR_ID_PROFIL]->getDefaut_numero_compte()) {
        echo $profils[$FOURNISSEUR_ID_PROFIL]->getDefaut_numero_compte();
    } else {
        echo "...";
    } ?>
                                </span>
                            ...
                            <td>
                                <span id="aff_numero_compte_compta_fournisseur" ><?php $lcpt = new compta_plan_general($profils[$FOURNISSEUR_ID_PROFIL]->getDefaut_numero_compte());
    echo $lcpt->getLib_compte(); ?></span>
                            </td>
                        </tr>
                    </table>
                    <hr />
...
if (isset($profils[$CLIENT_ID_PROFIL])) {
    ...
    <?php if ($profils[$CLIENT_ID_PROFIL]->getDefaut_numero_compte()) {
        echo $profils[$CLIENT_ID_PROFIL]->getDefaut_numero_compte();
    } else {
        echo "...";
    } ?>
                                </span>
                            ...
                            <td>
                                <span id="aff_numero_compte_compta_client" ><?php $lcpt = new compta_plan_general($profils[$CLIENT_ID_PROFIL]->getDefaut_numero_compte());
    echo $lcpt->getLib_compte(); ?></span>
                            </td>
                        </tr>
                    </table>
...
//changements sur le formulaire principal
    new Form.EventObserver('annu_editon_fiche_form', function (element, value) {
        formChanged();
    ...
    Event.observe('nom', 'click', function (element, value) {
        formChanged();
        $("submit").style.visibility = "visible";
    }, false);
    Event.observe('nom', 'keypress', function (element, value) {
        formChanged();
        $("submit").style.visibility = "visible";
    }, false);
    Event.observe('note', 'click', function (element, value) {
        formChanged();
        $("submit2").style.visibility = "visible";
    }, false);
    Event.observe('note', 'keypress', function (element, value) {
        formChanged();
        $("submit2").style.visibility = "visible";
    }, false);
    Event.observe('line_siret4', 'click', function (element, value) {
        formChanged();
        $("submit").style.visibility = "visible";
    }, false);
...
//action de fusion suspension suppression
    ...
    Event.observe('fusionner_contact', 'click', function (evt) {
        show_mini_moteur_contacts('fusionner_contact', '\'<?php echo $contact->getRef_contact(); ?>\'');
        Event.stop(evt);
    }, false);


    Event.observe('suspendre_user', 'click', function (evt) {
        alerte.confirm_supprimer('contact_suspendre_user', 'contact_suspendre_user');
        Event.stop(evt);
    }, false);

    if ($("contact_archivage"))
        Event.observe('supprimer_contact', 'click', function (evt) {
            alerte.confirm_supprimer('contact_archivage', 'contact_archivage');
            Event.stop(evt);
        }, false);
