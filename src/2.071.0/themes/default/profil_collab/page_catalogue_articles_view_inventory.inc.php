...
<input type="hidden" name="ref_article_inventory" id="ref_article_inventory" value="<?php echo $article->getRef_article ();?>" />
	...
	<table style="width:100%">
		...
		<tr>
			...
			<td style="text-align:left">&nbsp;</td>
			<td style="text-align:center">&nbsp;</td>
			<td style="text-align:left"><span style="text-align:right"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt_inv_valider.gif" id="valid_inventory" style="cursor:pointer" /></span></td>
			<td></td>
		</tr>
		<?php 
