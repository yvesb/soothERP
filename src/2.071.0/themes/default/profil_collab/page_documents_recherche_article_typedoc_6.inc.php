...
<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-arenouveller.gif" id="bt_r_cdf_1" style="cursor:pointer"/>
<img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-acommander.gif" id="bt_r_cdf_2" style="cursor:pointer"/>
</div>
