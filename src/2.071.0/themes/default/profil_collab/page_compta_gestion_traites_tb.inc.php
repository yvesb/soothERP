	...
	<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
		<tr>
			...
			<br />
					...
					<br />
					<br />
					<span id="import_ope" class="grey_caisse"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" /> Historique des traites</span><br /><br />
