					...
					<div>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
                                                        ...
                                                        <tr>
                                                            <td><div class="bold_caisse" style="font-size:16px">Traites &agrave; effectuer (<span id="detail_traitena_links"> <span id = "detail_traitena_show_link" class="green_underlined" style="font-size:12px"> Voir le d&eacute;tail </span><span id = "detail_traitena_hide_link" class="green_underlined" style="font-size:12px;display:none;">Masquer le d&eacute;tail</span></span> )</div></td>
                                                            <td><div class="bold_caisse" style="font-size:16px"><?php echo number_format($traitena_a_effectuer, $TARIFS_NB_DECIMALES, ".", ""	)." ".$MONNAIE[1];?></div></td>
                                                            <td style="width:20%"><div class="bold_caisse" style="font-size:16px">&nbsp;</div></td>
                                                            <script type="text/javascript">
                                                            Event.observe("detail_traitena_links", "click",  function(evt){
                                                                   Event.stop(evt);
                                                                   $("detail_traitena_show_link").toggle();
                                                                   $("detail_traitena_hide_link").toggle();
                                                                   $("detail_traitena").toggle();
                                                            }, false);
                                                            </script>
							</tr>
                                                        <tr id = "detail_traitena" style="display:none;">
                                                            <td colspan="2">
                                                                <table>
                                                                    <?php
                                                                    foreach ($infos_traitena as $traitena){
                                                                    ?>
                                                                    <tr><td style="font-style:italic"><?php echo contact::_getNom($traitena->ref_contact); ?></td><td style="font-style:italic"><?php echo number_format($traitena->montant, $TARIFS_NB_DECIMALES, ".", "")." ".$MONNAIE[1];; ?></td><td style="font-style:italic">le <?php echo date_Us_to_Fr($traitena->date) ?></td><td style="font-style:italic"><?php echo $traitena->ref_doc ?></td><td style="font-style:italic">(<?php echo $traitena->type_reglement ?>)</td></tr>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </table>
							...
							<tr>
								...
								<span style="color:#97bf0d; float:right">
                                                                    <span id="prelev_compte_<?php echo $compte_bancaire->getId_compte_bancaire(); ?>"  class="green_underlined"  ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-prelever.gif" alt="Prelevement"/>
                                                                    </span>
                                                                    &nbsp; - &nbsp;
                                                                    <span id="traitena_compte_<?php echo $compte_bancaire->getId_compte_bancaire(); ?>"  class="green_underlined"  ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-traite.gif" alt="Traite"/>
                                                                    </span>
								</span>
						...
						<br />
                                                ...
                                                ?>
                                                <font color="#cc0000">Attention ! Il vous manque des autorisations de pr&eacute;l&egrave;vement</font>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="2" class="line_caisse_bottom">&nbsp;</td>
								<td>&nbsp;</td>
						...
						<br />
                                                <br />
                                                <?php
                                                if (count($infos_traitena_sans_aut) > 0){
                                                ?>
                                                <font color="#cc0000">Attention ! Il vous manque des autorisations de traites</font>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="2" class="line_caisse_bottom">&nbsp;</td>
								<td>&nbsp;</td>
							...
							<tr>
                                                            <td><div class="bold_caisse" style="font-size:14px">Traites sans autorisation (<span id="detail_traitena_sans_aut_links"> <span id = "detail_traitena_sans_aut_show_link" class="green_underlined" style="font-size:12px"> Voir le d&eacute;tail </span><span id = "detail_traitena_sans_aut_hide_link" class="green_underlined" style="font-size:12px;display:none;">Masquer le d&eacute;tail</span></span> )</div></td>
                                                            <td><div class="bold_caisse" style="font-size:14px"><?php echo number_format($traitena_sans_auth_montant, $TARIFS_NB_DECIMALES, ".", ""	)." ".$MONNAIE[1];?></div></td>
                                                            <td style="width:20%"><div class="bold_caisse" style="font-size:16px">&nbsp;</div></td>
                                                            <script type="text/javascript">
                                                            Event.observe("detail_traitena_sans_aut_links", "click",  function(evt){
                                                                   Event.stop(evt);
                                                                   $("detail_traitena_sans_aut_show_link").toggle();
                                                                   $("detail_traitena_sans_aut_hide_link").toggle();
                                                                   $("detail_traitena_sans_aut").toggle();
                                                            }, false);
                                                            </script>
							</tr>
                                                        <tr id = "detail_traitena_sans_aut" style="display:none;">
                                                            <td colspan="2">
                                                                <table>
                                                                    <?php
                                                                    foreach ($infos_traitena_sans_aut as $traitena){
                                                                    ?>
                                                                    <tr><td style="font-style:italic"><?php echo contact::_getNom($traitena->ref_contact); ?></td><td style="font-style:italic"><?php echo number_format($traitena->montant, $TARIFS_NB_DECIMALES, ".", "")." ".$MONNAIE[1];; ?></td><td style="font-style:italic">le <?php echo date_Us_to_Fr($traitena->date) ?></td><td style="font-style:italic"><?php echo $traitena->ref_doc ?></td><td style="font-style:italic">(<?php echo $traitena->type_reglement ?>)</td></tr>
                                                                    <?php
                                                                    }
...
setheight_gestion_caisse();
	...
	Event.observe("prelev_compte_<?php echo $compte_bancaire->getId_compte_bancaire(); ?>", "click", function(evt){
		Event.stop(evt);
		page.verify("compta_gestion_traites_prelev_prelevements", "compta_gestion_traites_prelev_prelevements.php?id_compte_bancaire=<?php echo $compte_bancaire->getId_compte_bancaire(); ?>", "true", "sub_content");
	}, false);

        Event.observe("traitena_compte_<?php echo $compte_bancaire->getId_compte_bancaire(); ?>", "click", function(evt){
		Event.stop(evt);
		page.verify("compta_gestion_traites_prelev_traite", "compta_gestion_traites_prelev_traite.php?id_compte_bancaire=<?php echo $compte_bancaire->getId_compte_bancaire(); ?>", "true", "sub_content");
	}, false);
