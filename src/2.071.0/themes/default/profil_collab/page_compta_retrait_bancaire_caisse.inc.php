...
<div class="titre" style="width:60%; padding-left:140px">Retrait bancaire vers <?php echo htmlentities($compte_caisse->getLib_caisse(), ENT_QUOTES, "UTF-8"); ?>
</div>
...
<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<div class="emarge"><br />
			...
			</span> ʈ destination de <?php echo htmlentities($compte_caisse->getLib_caisse(), ENT_QUOTES, "UTF-8"); ?>
			<br />
			<br />
