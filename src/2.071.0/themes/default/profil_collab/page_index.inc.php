...
?>
    ...
    <body class="collab" id="id_body" onclick="close_mini_calendrier();" style="background-image: url(<?php echo $DIR . $_SESSION['theme']->getDir_gtheme() ?>images/main_content_bg.gif); background-repeat:repeat-x; background-attachment:fixed">
                                            ...
                                            foreach ($smenu[5] as $ssmenu) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($ssmenu[0] == "separateur") {
                                                        ...
                                                        <?php } elseif ($ssmenu[0] == "lien_externe") {
                                                            ?>
                                                            <td>
                                                    ...
                                                    <div id="right_content"  style="display:none">
                                                        ...
                                                        <div id="deco"><a href="<?php echo $CORE_DIR ?>site/__session_stop.php">Déconnexion</a></div>
                                                        <div></div>
                                                    </div>
...
<iframe src="about:blank" style="display: none; right: 15%; position: absolute; top:50px; height:450px;z-index:231;width:50%;background-color:#fff;" scrolling="auto" id="formFrame" name="formFrame"></iframe>
