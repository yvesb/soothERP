...
// barre_navigation
// ------------------------------------------------------------------------
function barre_navigation($nbtotal, $nbenr, $cfg_nbres_ppage, $debut, $cfg_nb_pages, $idformtochange, $fonctiontolauch) {
    // --------------------------------------------------------------------
...
$barre_nav .= barre_navigation($nb_fiches, $form['page_to_show'], $form['fiches_par_page'], $debut, $cfg_nb_pages, 'page_to_show_s', 'page.documents_recherche_simple()');
    ...
    if ($_SESSION['user']->check_permission("6") || $fiche->id_type_groupe != 2) {
        ...
        ?>
                <tr class="<?php echo $class_colorise ?>">
                    <td style="width:25px">
                        <input id="check_s_<?php echo $indentation; ?>" name="check_s_<?php echo $indentation; ?>" type="checkbox" value="<?php if ($fiche->ref_doc) {
            echo ($fiche->ref_doc);
        } ?>"/>
                    </td>
                    <td class="reference">
        ...
        <?php if ($fiche->ref_doc) {
            echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") . "&nbsp;";
        } ?>		
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_ref_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
                    </td>
                    <td>
                        ...
                        <script type="text/javascript">
                            Event.observe("link_type_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
                ...
                <?php if ($fiche->lib_etat_doc) {
                    echo htmlentities($fiche->lib_etat_doc, ENT_QUOTES, "UTF-8");
                } ?>&nbsp;
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_etat_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
                    ...
                    <td style="text-align:left">
                        <a  href="#" id="link_contact_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>" style="display:block; width:100%" alt="<?php if ($fiche->nom_contact) {
            echo str_replace("€", "&euro;", $fiche->nom_contact);
        } ?>" title="<?php if ($fiche->nom_contact) {
            echo ($fiche->nom_contact);
        } ?>">
        <?php if ($fiche->nom_contact) {
            echo str_replace("€", "&euro;", substr($fiche->nom_contact, 0, 38));
        } ?>&nbsp;
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_contact_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
                    ...
                    <td style="text-align:left">
                        <a  href="#" id="link_ref_externe_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>" style="display:block; width:100%">
                            <?php if (isset($fiche->ref_doc_externe)) {
                                echo htmlentities($fiche->ref_doc_externe, ENT_QUOTES, "UTF-8") . "&nbsp;";
                            } ?>
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_ref_externe_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
        ...
        <?php if ($fiche->montant_ttc) {
            echo number_format($fiche->montant_ttc, $TARIFS_NB_DECIMALES, ".", "") . " " . $MONNAIE[1];
            $montant_total_page +=$fiche->montant_ttc;
        } ?>&nbsp;
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_montant_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
        ...
        <?php if ($fiche->date_doc) {
            echo htmlentities(date_Us_to_Fr($fiche->date_doc), ENT_QUOTES, "UTF-8");
        } ?>&nbsp;
                        </a>
                        <script type="text/javascript">
                            Event.observe("link_date_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>', 'true', 'sub_content');
                            }, false);
                        </script>
                    ...
                    <td style="vertical-align:middle; text-align:center">
                        ...
                        <script type="text/javascript">
                            Event.observe("link_edit_doc_<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>", "click", function (evt) {
                                Event.stop(evt);
                                page.verify('documents_edition', 'index.php#' + escape('documents_edition.php?ref_doc=<?php echo htmlentities($fiche->ref_doc, ENT_QUOTES, "UTF-8") ?>'), 'true', '_blank');
                            }, false);
                        </script>
                    </td>
                    <td style="vertical-align:middle; text-align:center">
...
<script type="text/javascript">
    Event.observe("order_ref_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'ref_doc';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "ref_doc") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
    ...
    Event.observe("order_type_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'lib_type_doc';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "lib_type_doc") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
    ...
    Event.observe("order_etat_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'lib_etat_doc';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "lib_etat_doc") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
    ...
    Event.observe("order_contact_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'nom_contact';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "nom_contact") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
    ...
    Event.observe("order_montant_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'montant_ttc';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "montant_ttc") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
    ...
    Event.observe("order_date_doc", "click", function (evt) {
        Event.stop(evt);
        $('orderby_s').value = 'date_doc';
        $('orderorder_s').value = '<?php if ($form['orderorder'] == "ASC" && $form['orderby'] == "date_doc") {
    echo "DESC";
} else {
    echo "ASC";
} ?>';
