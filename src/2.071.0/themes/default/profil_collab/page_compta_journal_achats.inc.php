...
<div class="emarge">
<div class="titre">Journal des achats <?php if (isset($_REQUEST["ref_contact"])) { echo $contact->getNom(); } ?></div>
...
<!--	<input type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-imprimer.gif"  onclick="javascript:window.print()"/>-->
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
		 ...
		 <img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-imprimer.gif" alt="Imprimer" title="Imprimer" style="cursor:pointer" id="print_grand_livre"/>
	...
	<br />
		...
		<div id="compta_journal_achats_result_content" style="OVERFLOW-Y: auto; OVERFLOW-X: auto;">
...
<SCRIPT type="text/javascript">
	...
	Event.observe("print_grand_livre", "click", function(evt){
		Event.stop(evt);
		window.open ("compta_journal_achats_result.php?recherche=1&print=1&page_to_show_s="+$("page_to_show_s").value+"&ref_contact="+$("ref_contact").value+"&numero_compte="+$("numero_compte").value+"&date_fin="+$("date_fin").value+"&date_debut="+$("date_debut").value+"&date_exercice="+$("date_exercice").value, "_blank");
	}, false);
...
set_tomax_height("compta_journal_achats_result_content" , -42);
}
