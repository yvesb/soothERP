...
<div id="recherche" class="corps_moteur">
	<div id="recherche_avancee"   class="menu_link_affichage">
		<form action="#" id="form_recherche_avancee" method="GET" onsubmit="page.compta_fournisseur_comptes_plan(); return false;" >
			<table style="width:97%">
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td>
					<input name="id_profil" id="id_profil"  value="<?php echo $FOURNISSEUR_ID_PROFIL;?>" type="hidden"></td>
					<td></td>
					<td>&nbsp;</td>
				</tr>
				<tr id="liste_categ_fournisseur" >
					...
					<select  id="id_fournisseur_categ"  name="id_fournisseur_categ" class="classinput_xsize">
						...
						foreach ($liste_categories_fournisseur as $liste_categorie_fournisseur){
							?>
							<option value="<?php echo $liste_categorie_fournisseur->id_fournisseur_categ;?>" >
				...
				<tr>
					<td>&nbsp;</td>
					<td></td>
					<td><input name="submit" type="image" onclick="$('page_to_show').value=1;" src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-rechercher.gif"  style="float:left"/>
					</td>
					<td>&nbsp;</td>
					<td></td>
					<td style="text-align:right">
