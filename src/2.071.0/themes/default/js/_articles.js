...
function art_add_liaison(id_liaison, id_article, lib_article) {
    ...
    Event.observe($("liaison_img_del_" + num_serie), "click", function () {
        remove_tag("liaison_li_" + num_serie);
    });
    Event.observe("ratio_" + num_serie, "blur", function (evt) {
        nummask(evt, 0, "X.X");
    }, false);
...
function art_edition_add_liaison(id_liaison, id_article, lib_article) {
    ...
    Event.observe($("liaison_img_del_" + num_serie), "click", function () {
        alerte.confirm_supprimer_tag_and_callpage("liaison_art_del", "liaison_li_" + num_serie, "catalogue_articles_edition_liaison_supp.php?ref_article=" + $('ref_article').value + "&ref_article_lie=" + id_article + "&id_liaison_type=" + id_liaison);
    });
