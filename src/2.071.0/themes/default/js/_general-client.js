...
function check_majinfos_contact() {//livraison_ref_adresse
    ...
    {
        listes_alertes += "nom, ";
        changeclassname("nom", "alerteform_xsize");
    }
    ...
    {
        listes_alertes += "adresse, ";
        changeclassname("facturation_adresse", "alerteform_xsize");
    }
    if ($("facturation_code_postal").value == "")
    {
        listes_alertes += "code postal, ";
        changeclassname("facturation_code_postal", "alerteform_xsize");
    }
    if ($("facturation_ville").value == "")
    {
        listes_alertes += "ville, ";
        changeclassname("facturation_ville", "alerteform_xsize");
    }
