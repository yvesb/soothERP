  ...
  <tr>
  	...
  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  		...
  		<tr>
  			...
  			<td class="doc_infos_colors"><a href="documents_editing_print.php?ref_doc=<?php echo $doc_archive->getRef_doc();?>&code_pdf_modele=<?php echo $CODE_PDF_MODELE_DEV;?>" target="_blank" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_gtheme()?>images/bt-pdf.gif"/></a> </td>
  		</tr>
  		<?php 
  		}
  		?>
