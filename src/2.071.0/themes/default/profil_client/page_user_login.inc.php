                                                                ...
                                                                <table width="355px" border="0" >
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <input type=text name="login"  id="login" class="focusinput_xsize" value="<?php if (isset($predefined_user[0])) {
                                                        echo $predefined_user[0];
                                                    } ?>">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
