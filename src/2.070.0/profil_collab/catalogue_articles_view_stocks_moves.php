...
$art_stocks_moves =  $article->charger_stocks_moves ($_REQUEST['id_stock']);
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_articles_view_stock_moves.inc.php");
