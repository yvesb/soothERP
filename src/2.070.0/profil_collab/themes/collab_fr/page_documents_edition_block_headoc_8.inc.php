...
// *************************************************************************************************************
// CONTROLE DU THEME FACTURE FOURNISSEUR
// *************************************************************************************************************
		...
		<td colspan="3">
									...
									<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
										<tr>
											...
											if ($document->getId_etat_doc () == 32) {
												?>
											<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt_faf_aregler.gif" id="facture_a_regler" style="cursor:pointer"/>
			...
			<script type="text/javascript">
				...
				if ($document->getId_etat_doc () == 32) {
					?>
					//devis pret
					Event.observe("facture_a_regler", "click", function(evt){Event.stop(evt); maj_etat_doc (34);
						$("facture_a_regler").hide();  }, false);
				<?php
				}
				?>
...
<script type="text/javascript">
<?php
if ($document->getId_etat_doc () == 34 || $document->getId_etat_doc () == 35 ) {
	?>
	$("doc_menu_7").show();
	<?php
} else {
