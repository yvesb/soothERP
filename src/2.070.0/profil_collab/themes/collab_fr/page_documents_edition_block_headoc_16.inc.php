		...
		<td colspan="3">
			...
			?>
				...
				if ($document->getId_etat_doc () == 63) {
					?>
					//cotation prete
					Event.observe("cotation_prete", "click", function(evt){Event.stop(evt); maj_etat_doc (64); $("cotation_prete").hide(); }, false);
				<?php 
				}
				?>
				<?php 
				...
				//cotation vers commande
				Event.observe("cotation_to_blc", "click", function(evt){Event.stop(evt); generer_new_open_doc ("BLC"); $("cotation_to_blc").hide(); }, false);
				<?php 
				}
				?>
