...
<form id="form_assistant_tarif" name="form_assistant_tarif" method="post" action="catalogue_articles_edition_tarifs_formule.php" target="formFrame">
...
<input name="assistant_ref_article"  id="assistant_ref_article" type="hidden" value="<?php echo $article->getRef_article ();?>">		
<?php 
if ($USE_FORMULES) {
	?>
