...
<div class="">
	...
	<table class="minimizetable">
		...
		<tr>
			...
			<td style="display:none;"><input type="checkbox" id="chk_messagerie_collab" name="chk_messagerie_collab"/><label for="chk_messagerie_collab">Cr&eacute;er compte de Messagerie Interne</label>
			</td>
		</tr>
	</table>
</div>
