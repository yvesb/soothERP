...
if (bad_lib_web_link) {
	window.parent.document.getElementById("lib_web_link_<?php echo $_REQUEST["ident"];?>").className="alerteform_xsize";
	window.parent.document.getElementById("lib_web_link_<?php echo $_REQUEST["ident"];?>").focus();
texte_erreur += "Indiquez un titre au lien.<br/>";
} else {
	window.parent.document.getElementById("lib_web_link_<?php echo $_REQUEST["ident"];?>").className="classinput_xsize";
}
