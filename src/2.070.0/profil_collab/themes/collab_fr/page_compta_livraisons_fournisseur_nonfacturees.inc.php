...
<p class="titre">Livraisons Fournisseurs non factur&eacute;es</p>
...
<?php include $DIR.$_SESSION['theme']->getDir_theme()."page_compta_livraisons_fournisseur_nonfacturees_liste.inc.php";?>
</div>
...
foreach ($stocks_liste as $stocks) {
	...
	Event.observe('menu_<?php echo $i;?>', "click", function(evt){
		...
		load_livraison_fournisseur_nonfacturees ("<?php echo $stocks->getId_stock ();?>", "", "");
		Event.stop(evt);
});
	<?php 
