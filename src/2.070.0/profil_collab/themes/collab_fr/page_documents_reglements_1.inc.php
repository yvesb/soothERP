...
R&eacute;ception d'un r&egrave;glement en esp&egrave;ces<br />
<br />
...
if (count($comptes_caisses)) {
	...
	<table border="0" cellspacing="0" cellpadding="0" style="width:100%">
		<tr>
			<td style="width:55%">
			<input id="id_reglement_mode" name="id_reglement_mode" value="<?php echo $_REQUEST["id_reglement_mode"]; ?>" type="hidden" /> 
			<input id="ref_contact" name="ref_contact" value="<?php echo $ref_contact; ?>" type="hidden" /> 
		...
		<tr>
			<td>Caisse: </td>
			<td>
			<select id="id_compte_caisse_dest1" name="id_compte_caisse_dest1" class="classinput_xsize" >
			<?php 
