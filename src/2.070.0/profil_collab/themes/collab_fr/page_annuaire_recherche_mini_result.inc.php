...
<table  cellspacing="0" id="tableresult">
	...
	foreach ($fiches as $fiche) {
		...
		<tr class="<?php  echo  $class_colorise?>">
			<td>
				<span id="nom_<?php echo ($fiche->ref_contact)?>" class="clic"> <?php echo nl2br(($fiche->nom))?> (<?php echo ($fiche->lib_civ_court)?>)</span>
				<script type="text/javascript">
			...
			<td  style="width:25%; text-align:right">
				<span class="clic" id="adresse_<?php echo ($fiche->ref_contact)?>" title="<?php	if ($fiche->text_adresse) { echo (($fiche->text_adresse));}?>">
			...
			<td style="width:20%; text-align:left">
				<span class="clic" id="ville_<?php echo ($fiche->ref_contact)?>">
			...
			<td>
				<span class="clic" id="tel_<?php echo ($fiche->ref_contact)?>">
