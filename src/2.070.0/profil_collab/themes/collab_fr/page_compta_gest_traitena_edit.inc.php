<div class="headbar">
    <span id="link_close_pop_up_traitena" style="float:right" class="clic">
        <img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/supprime.gif" border="0">
    </span>
    <script type="text/javascript">
        Event.observe("link_close_pop_up_traitena", "click",  function(evt){Event.stop(evt); $("pop_up_traitena").hide();}, false);
    </script>
</div>
<div class="popup-content">
    ...
    <script type="text/javascript">
        ...
        preselect('<?php echo $current->id_piece_jointe_autorisation ?>', 'id_pj_traitena');
