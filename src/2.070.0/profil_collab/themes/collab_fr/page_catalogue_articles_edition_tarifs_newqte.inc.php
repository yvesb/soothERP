...
Event.observe('tarif_del_<?php echo $nb_liste_tarif?>_<?php echo $nb_ligne_prix?>', "click", function(evt){
	Event.stop(evt); 
	alerte.confirm_supprimer_formule('tarif_del_art_formule', 'catalogue_articles_edition_tarifs_sup.php', 'ref_article=<?php echo $_REQUEST["ref_article"];?>&indice_qte='+$("qte_tarif_<?php echo $nb_ligne_prix?>").value+'&id_tarif=<?php echo $tarif_liste->id_tarif;?>&n_liste=<?php echo $nb_liste_tarif?>_<?php echo $nb_ligne_prix?>&nb_ligne_prix=<?php echo $nb_ligne_prix?>&reset_formule=<?php
					if ($tarif_liste->formule_tarif=="") {
