	...
	?>
		<tr id="line_compte_comptable" style="">
			...
			Event.observe('numero_compte_compta_fournisseur_<?php echo $fiche->ref_fournisseur;?>', 'click',  function(evt){
				...
				charger_compta_plan_mini_moteur ("compte_plan_comptable_search.php?cible=compta_fournisseur&cible_id=<?php echo $fiche->ref_fournisseur;?>&retour_value_id=numero_compte_compta_fournisseur_<?php echo $fiche->ref_fournisseur;?>&retour_lib_id=aff_numero_compte_compta_fournisseur_<?php echo $fiche->ref_fournisseur;?>&indent=numero_compte_compta_fournisseur_<?php echo $fiche->ref_fournisseur;?>&num_compte=<?php echo ($fiche->categ_defaut_numero_compte) ? $fiche->categ_defaut_numero_compte : $DEFAUT_COMPTE_TIERS_ACHAT;?>");
				Event.stop(evt);
			},false); 
