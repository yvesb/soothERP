...
<div class="emarge">
<div class="titre">Grand livre fournisseurs</div>
...
<SCRIPT type="text/javascript">
	...
	Event.observe("print_grand_livre", "click", function(evt){
		...
		window.open ("compta_extrait_compte_contact_solde_det.php?id_profil=fournisseurs&&date_fin="+$("date_fin").value+"&date_debut="+$("date_debut").value+"&date_exercice="+$("date_exercice").value+equi, "_blank");
	}, false);
