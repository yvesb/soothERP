...
<div class="titre" id="titre_crea_art" style="width:60%; padding-left:140px">Liste des destinataires &gt;&gt; <?php echo $newsletter->getNom_newsletter() ?> 
 
</div>
<br />
<strong>Envoi: <?php echo $envoi->titre;?> du  <?php echo date_Us_to_Fr($envoi->date_envoi);?></strong>
...
<div>
			...
			<td class="bolder" style="text-align:left">Lu
			</td>
			<td>&nbsp;
			</td>
			</tr>
			...
			foreach ($liste_envois as $dest) {
				...
				<td style="text-align:left">
					<?php if (!$dest->lecture) {echo "Non lu";}?>
				</td>
				<td>
				</td>
				</tr>
