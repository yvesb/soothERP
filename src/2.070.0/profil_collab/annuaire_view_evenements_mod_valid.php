...
$contact->mod_evenement ($_REQUEST["id_comm_event"], $date_event, $duree_event, $ref_user, $id_comm_event_type, $texte, $date_rappel);

// *************************************************************************************************************
// AFFICHAGE
// *************************************************************************************************************

include ($DIR.$_SESSION['theme']->getDir_theme()."page_annuaire_view_evenements_mod_valid.inc.php");
