...
$query = "SELECT cb2.id_compte_bancaire,cb2.lib_compte,d.ref_doc,a1.ref_contact ,de.id_doc_echeance, de.date, de.type_reglement ,cb2.iban, cba.id_compte_bancaire_autorisation, montant
                ...
                JOIN (SELECT cba0.id_compte_bancaire_src, cba0.id_compte_bancaire_dest, cba0.id_compte_bancaire_autorisation FROM comptes_bancaires_autorisations cba0
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_compta_gestion_traites_prelevements.inc.php");
}
?>