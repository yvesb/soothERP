//Maj de liaison pour un article

function art_maj_liaison(id_article, id_liaison, ratio){

			var AppelAjax = new Ajax.Request(
				"catalogue_articles_edition_liaison_maj.php",
				{
				parameters: {ref_article_lie: id_article, id_liaison_type: id_liaison, ref_article: $('ref_article').value, ratio: ratio}
				}
			);
}
...
function art_add_liaison(id_liaison, id_article, lib_article) {
	...
	var num_serie	=	$('serialisation_liaison').value;
	var zone= $("liaison_ul_"+id_liaison);
	var addli= document.createElement("li");
		addli.setAttribute ("id", "liaison_li_"+num_serie);
	var input1= document.createElement("input");
		input1.setAttribute ("id", "ref_article_lie_"+num_serie);
		input1.setAttribute ("name", "ref_article_lie_"+num_serie);
		input1.setAttribute ("type", "hidden");
		input1.setAttribute ("value", id_article);
	var input2= document.createElement("input");
		input2.setAttribute ("id", "id_liaison_type_"+num_serie);
		input2.setAttribute ("name", "id_liaison_type_"+num_serie);
		input2.setAttribute ("type", "hidden");
		input2.setAttribute ("value", id_liaison);
	var image= document.createElement("img");
		image.setAttribute ("id", "liaison_img_del_"+num_serie);
	...
	html_content="<table width=100%><tr><td style=\"width:20%\">"+id_article+"</td>";
	html_content+="<td style=\"width:58%\">"+lib_article+"</td>";
	html_content+="<td style=\"width:17%\"><input type=\"text\" name=\"ratio_"+num_serie+"\" id=\"ratio_"+num_serie+"\" value=\"1\"  class=\"classinput\" size=\"5\">";
	html_content+="&nbsp;pour 1	</td>";
	html_content+="<td style=\"width:5%\"><img id=\"liaison_img_del_"+num_serie+"\" src=\""+dirtheme+"images/supprime.gif\"/></td></tr></table>";
	$("liaison_div_"+num_serie).innerHTML=html_content;
	$("liaison_li_"+num_serie).appendChild(input1);
	$("liaison_li_"+num_serie).appendChild(input2);
	$('serialisation_liaison').value= parseInt(num_serie)+1;
	close_mini_moteur_cata();
	
	
	
/*	$("liaison_li_"+num_serie).appendChild(image);
	$("liaison_li_"+num_serie).appendChild(divli);
	$("liaison_div_"+num_serie).innerHTML=lib_article;
	$("liaison_li_"+num_serie).appendChild(input1);
	$("liaison_li_"+num_serie).appendChild(input2);
	$('serialisation_liaison').value= parseInt(num_serie)+1;
	close_mini_moteur_cata();
...
Event.observe( $("liaison_img_del_"+num_serie) , "click", function(){remove_tag ("liaison_li_"+num_serie);});
...
function art_edition_add_liaison(id_liaison, id_article, lib_article) {
	...
	html_content+="<td style=\"width:58%\">"+lib_article+"</td>";
	html_content+="<td style=\"width:17%\"><input type=\"text\" name=\"ratio_"+num_serie+"\" id=\"ratio_"+num_serie+"\" value=\"1\"  class=\"classinput\" size=\"5\">";
	html_content+="&nbsp;pour 1<input type=\"hidden\" name=\"old_ratio_"+num_serie+"\" id=\"old_ratio_"+num_serie+"\" value=\"1\">	</td>";
	html_content+="<td style=\"width:5%\"><img id=\"liaison_img_del_"+num_serie+"\" src=\""+dirtheme+"images/supprime.gif\"/></td></tr></table>";
	$("liaison_div_"+num_serie).innerHTML=html_content;
	$("liaison_li_"+num_serie).appendChild(input1);
	$("liaison_li_"+num_serie).appendChild(input2);
...
Event.observe( $("liaison_img_del_"+num_serie) , "click", function(){alerte.confirm_supprimer_tag_and_callpage ( "liaison_art_del", "liaison_li_"+num_serie, "catalogue_articles_edition_liaison_supp.php?ref_article="+$('ref_article').value+"&ref_article_lie="+id_article+"&id_liaison_type="+id_liaison);});

Event.observe( "ratio_"+num_serie , "blur", function(evt){

	if ($("ratio_"+num_serie).value != $("old_ratio_"+num_serie).value){

		art_maj_liaison(id_article,id_liaison,$("ratio_"+num_serie).value);
		$("old_ratio_"+num_serie).value = $("ratio_"+num_serie).value;
	}
}, false);
...
var AppelAjax = new Ajax.Request(
																...
																{
																parameters: {ref_article_lie: id_article, id_liaison_type: id_liaison, ref_article: $('ref_article').value}
																}
																);
}
...
function insert_art_inventory_line_sn (indentation_sn) {
	...
	$("more_sn_"+indentation_sn).innerHTML = "sn: ";
