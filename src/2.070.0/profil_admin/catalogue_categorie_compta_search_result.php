<?php
// *************************************************************************************************************
// RECHERCHE POUR Modification compte par défaut d'art_categ
// *************************************************************************************************************
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_catalogue_categorie_compta_search_result.inc.php");
