...
<p class="titre">Gestion des mod&egrave;les d&acute;export de r&eacute;sultat commerciaux</p>
<div style="height:50px">
<div class="contactview_corps">
	<table style="width:100%;">
		<tr>
			<td class="titre_config" colspan="4">Ajouter un mod&egrave;le d&acute;export de r&eacute;sultat commerciaux	</td>
		</tr>
		<tr>
			<td>
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <input type="radio" name="def_export_<?php echo $modele_export->id_export_modele; ?>" id="def_export_<?php echo $modele_export->id_export_modele; ?>" <?php if ($modele_export->usage == "defaut") {?> checked="checked" <?php } ?> />
                                        ...
                                        <form action="communication_mod_export_resultat_commerciaux_def.php" method="post" id="communication_mod_export_resultat_commerciaux_def_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_resultat_commerciaux_def_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                 ...
                                 Event.observe('def_export_<?php echo $modele_export->id_export_modele; ?>', "click" , function(evt){
                                        if ($('def_export_<?php echo $modele_export->id_export_modele;?>').checked == true) {
                                                $("communication_mod_export_resultat_commerciaux_def_<?php echo $modele_export->id_export_modele;?>").submit();
                                        }
                                 } , false);
                                        </script>
                                        <?php } ?> 
                                ...
                                <?php if ($modele_export->usage != "defaut") {?>
                                 ...
                                 Event.observe('unactive_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                                $("communication_mod_export_resultat_commerciaux_des_<?php echo $modele_export->id_export_modele;?>").submit();
                                 } , false);
                                        </script>
                                <?php } ?>
                                </td>
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <td style="width:15%">
                                        ...
                                        <form action="communication_mod_export_resultat_commerciaux_act.php" method="post" id="communication_mod_export_resultat_commerciaux_act_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_resultat_commerciaux_act_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                 ...
                                 Event.observe('active_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                     $("communication_mod_export_resultat_commerciaux_act_<?php echo $modele_export->id_export_modele;?>").submit();
