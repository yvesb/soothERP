...
window.parent.document.getElementById("formule_add_<?php echo $cellule_cible?>").value="1";
window.parent.document.getElementById('tarif_del_<?php echo $cellule_cible?>').style.display="";
