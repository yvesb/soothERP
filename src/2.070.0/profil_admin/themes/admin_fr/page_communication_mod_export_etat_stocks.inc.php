...
tableau_smenu[1] = Array('communication_mod_export_etat_stocks','communication_mod_export_etat_stocks.php','true','sub_content', 'Mod&egrave;les d&acute;export d&acute;&eacute;tat de stocks');
update_menu_arbo();
</script>
<div class="emarge">

<p class="titre">Gestion des mod&egrave;les d&acute;export d&acute;&eacute;tat de stocks</p>
<div style="height:50px">
<div class="contactview_corps">
	<table style="width:100%;">
		<tr>
			<td class="titre_config" colspan="4">Ajouter un mod&egrave;le d&acute;export d&acute;&eacute;tat de stocks	</td>
		</tr>
		<tr>
			<td>
				<form action="communication_mod_export_etat_stocks_add.php" enctype="multipart/form-data" method="POST"  id="communication_mod_export_etat_stocks_add" name="communication_mod_export_etat_stocks_add" target="formFrame" >
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none" id="step2_b">
			<tr>
				...
				<td style="width:30%">
					<select name="id_export_modele" id="choix_id_export_etat_stocks" class="classinput_xsize">
					<?php 
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <input type="radio" name="def_export_<?php echo $modele_export->id_export_modele; ?>" id="def_export_<?php echo $modele_export->id_export_modele; ?>" <?php if ($modele_export->usage == "defaut") {?> checked="checked" <?php } ?> />
                                        ...
                                        <form action="communication_mod_export_etat_stocks_def.php" method="post" id="communication_mod_export_etat_stocks_def_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_etat_stocks_def_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                 ...
                                 Event.observe('def_export_<?php echo $modele_export->id_export_modele; ?>', "click" , function(evt){
                                        if ($('def_export_<?php echo $modele_export->id_export_modele;?>').checked == true) {
                                                $("communication_mod_export_etat_stocks_def_<?php echo $modele_export->id_export_modele;?>").submit();
                                        }
                                 } , false);
                                        </script>
                                        <?php } ?> 
                                ...
                                <?php if ($modele_export->usage != "defaut") {?>
                                        ...
                                        <form action="communication_mod_export_etat_stocks_des.php" method="post" id="communication_mod_export_etat_stocks_des_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_etat_stocks_des_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />                       
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('unactive_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                                $("communication_mod_export_etat_stocks_des_<?php echo $modele_export->id_export_modele;?>").submit();
                                 } , false);
                                        </script>
                                <?php } ?>
                                </td>
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <td style="width:15%">
                                        ...
                                        <form action="communication_mod_export_etat_stocks_act.php" method="post" id="communication_mod_export_etat_stocks_act_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_etat_stocks_act_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                 ...
                                 Event.observe('active_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                     $("communication_mod_export_etat_stocks_act_<?php echo $modele_export->id_export_modele;?>").submit();
