...
// *************************************************************************************************************
// ajout de modèle de résultats commerciaux pdf
// *************************************************************************************************************
...
if (erreur) {
  ...
  if (choisir_id_pdf_modele) {
    window.parent.document.getElementById("choix_id_pdf_resultats_commerciaux").className="alerteform_xsize";
    texte_erreur += "Vous devez sélectionner un modèle de document source.<br/>";
  } else {
    window.parent.document.getElementById("choix_id_pdf_resultats_commerciaux").className="classinput_xsize";
  }
...
window.parent.page.traitecontent('Communication_mod_resultats_commerciaux','communication_mod_resultats_commerciaux.php','true','sub_content');
