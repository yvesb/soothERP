                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <input type="radio" name="def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>" id="def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>" <?php if ($modele_pdf->usage == "defaut") {?> checked="checked" <?php } ?> />
                                        ...
                                        <form action="communication_mod_resultats_commerciaux_def.php" method="post" id="communication_mod_resultats_commerciaux_def_<?php echo $modele_pdf->id_pdf_modele;?>" name="communication_mod_resultats_commerciaux_def_<?php echo $modele_pdf->id_pdf_modele;?>" target="formFrame" >
                                 ...
                                 Event.observe('def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>', "click" , function(evt){
                                        if ($('def_pdf_<?php echo $modele_pdf->id_pdf_modele;?>').checked == true) { 
                                                $("communication_mod_resultats_commerciaux_def_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                        }
                                 } , false);
                                        </script>
                                        <?php } ?> 
                                ...
                                <?php if ($modele_pdf->usage != "defaut") {?>
                                 ...
                                 Event.observe('unactive_pdf_<?php echo $modele_pdf->id_pdf_modele;?>', "click" , function(evt){
                                                $("communication_mod_resultats_commerciaux_des_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                 } , false);
                                        </script>
                                <?php } ?>
                                </td>
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <td style="width:15%">
                                        ...
                                        <form action="communication_mod_resultats_commerciaux_act.php" method="post" id="communication_mod_resultats_commerciaux_act_<?php echo $modele_pdf->id_pdf_modele;?>" name="communication_mod_resultats_commerciaux_act_<?php echo $modele_pdf->id_pdf_modele;?>" target="formFrame" >
                                                <input name="id_pdf_modele" type="hidden" value="<?php echo $modele_pdf->id_pdf_modele; ?>" />
                                                
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('active_pdf_<?php echo $modele_pdf->id_pdf_modele;?>', "click" , function(evt){
                                        $("communication_mod_resultats_commerciaux_act_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                } , false);
                                        </script>
                                </td>
                        </tr>
