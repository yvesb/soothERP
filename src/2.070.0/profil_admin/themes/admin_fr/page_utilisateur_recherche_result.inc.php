...
<table  cellspacing="0" id="tableresult">
	...
	<tr class="<?php  echo  $class_colorise?>">
		...
		if ($fiche->actif) {
			?>
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/point_vert.gif" alt="utilisateur actif" title="utilisateur actif" />
			<?php
		} else {
			?>
			<img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/point_rouge.gif" alt="utilisateur actif" title="utilisateur actif" />
			<?php 
		} 
		?>
		</td>
