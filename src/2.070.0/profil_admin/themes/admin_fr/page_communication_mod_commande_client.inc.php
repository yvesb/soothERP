...
tableau_smenu[1] = Array('communication_mod_commande_client','communication_mod_commande_client.php','true','sub_content', 'Mod&egrave;les de commande client');
update_menu_arbo();
</script>
<div class="emarge">

<p class="titre">Gestion des mod&egrave;les de commande client</p>
<div style="height:50px">
<div class="contactview_corps">
	<table style="width:100%;">
		<tr>
			<td class="titre_config" colspan="4">Ajouter un mod&egrave;le de commande client</td>
		</tr>
		<tr>
			<td>
				<form action="communication_mod_commande_client_add.php" enctype="multipart/form-data" method="POST"  id="communication_mod_commande_client_add" name="communication_mod_commande_client_add" target="formFrame" >
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none" id="step2_b">
			<tr>
				...
				<td style="width:30%">
					<select name="id_pdf_modele" id="choix_id_pdf_commande_client" class="classinput_xsize">
					<?php 
...
if (count($liste_pour_activation)) {
	?>
	Modèles disponibles pour l'impression de commande client : 
        <?php
      //  $pdf_inactif = 0;
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <input type="radio" name="def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>" id="def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>" <?php if ($modele_pdf->usage == "defaut") {?> checked="checked" <?php } ?> />
                                        ...
                                        <form action="communication_mod_commande_client_def.php" method="post" id="communication_mod_commande_client_def_<?php echo $modele_pdf->id_pdf_modele;?>" name="communication_mod_commande_client_def_<?php echo $modele_pdf->id_pdf_modele;?>" target="formFrame" >
                                 ...
                                 Event.observe('def_pdf_<?php echo $modele_pdf->id_pdf_modele; ?>', "click" , function(evt){
                                        if ($('def_pdf_<?php echo $modele_pdf->id_pdf_modele;?>').checked == true) { 
                                                $("communication_mod_commande_client_def_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                        }
                                 } , false);
                                        </script>
                                        <?php } ?> 
                                ...
                                <?php if ($modele_pdf->usage != "defaut") {?>
                                        ...
                                        <form action="communication_mod_commande_client_des.php" method="post" id="communication_mod_commande_client_des_<?php echo $modele_pdf->id_pdf_modele;?>" name="communication_mod_commande_client_des_<?php echo $modele_pdf->id_pdf_modele;?>" target="formFrame" >
                                                <input name="id_pdf_modele" type="hidden" value="<?php echo $modele_pdf->id_pdf_modele; ?>" />
                                                
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('unactive_pdf_<?php echo $modele_pdf->id_pdf_modele;?>', "click" , function(evt){
                                                $("communication_mod_commande_client_des_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                 } , false);
                                        </script>
                                <?php } ?>
                                </td>
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <td style="width:15%">
                                        ...
                                        <form action="communication_mod_commande_client_act.php" method="post" id="communication_mod_commande_client_act_<?php echo $modele_pdf->id_pdf_modele;?>" name="communication_mod_commande_client_act_<?php echo $modele_pdf->id_pdf_modele;?>" target="formFrame" >
                                                <input name="id_pdf_modele" type="hidden" value="<?php echo $modele_pdf->id_pdf_modele; ?>" />
                                                
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('active_pdf_<?php echo $modele_pdf->id_pdf_modele;?>', "click" , function(evt){
                                        $("communication_mod_commande_client_act_<?php echo $modele_pdf->id_pdf_modele;?>").submit();
                                } , false);
                                        </script>
                                </td>
                        </tr>
