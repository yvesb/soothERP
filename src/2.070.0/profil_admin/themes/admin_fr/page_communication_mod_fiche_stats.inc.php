...
if (count($liste_pour_activation)) {
	...
	Modèles disponibles pour l'impression de fiche statistiques : 
      ...
      //  $pdf_inactif = 0;
        ...
        //if ($pdf_inactif) {
        ?>
        <span style="cursor:pointer; text-decoration:underline; display:" id="show_pdf_inactif_<?php echo $modele_pdf->id_stat; ?>">Utiliser un nouveau modèle d'impression.</span><br />
