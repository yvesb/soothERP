...
if (lib_carac_groupe_vide) {
	window.parent.document.getElementById("lib_carac_groupe_new").className="alerteform_xsize";
	window.parent.document.getElementById("lib_carac_groupe_new").focus();
	} else {
	window.parent.document.getElementById("lib_carac_groupe_new").className="classinput_xsize";
		}
