...
tableau_smenu[1] = Array('communication_mod_export_stats_vente','communication_mod_export_stats_vente.php','true','sub_content', 'Mod&egrave;les d&acute;export de statistique vente');
update_menu_arbo();
</script>
<div class="emarge">

<p class="titre">Gestion des mod&egrave;les d&acute;export de statistique vente</p>
<div style="height:50px">
<div class="contactview_corps">
	<table style="width:100%;">
		<tr>
			<td class="titre_config" colspan="4">Ajouter un mod&egrave;le d&acute;export de statistique vente	</td>
		</tr>
		<tr>
			<td>
				<form action="communication_mod_export_stats_vente_add.php" enctype="multipart/form-data" method="POST"  id="communication_mod_export_stats_vente_add" name="communication_mod_export_stats_vente_add" target="formFrame" >
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none" id="step2_b">
			<tr>
				...
				<td style="width:30%">
					<select name="id_export_modele" id="choix_id_export_stats" class="classinput_xsize">
					<?php 
...
if (count($liste_pour_activation)) {
	...
	Modèles disponibles pour l'impression de fiche statistiques : 
      ...
      //  $export_inactif = 0;
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <input type="radio" name="def_export_<?php echo $modele_export->id_export_modele; ?>" id="def_export_<?php echo $modele_export->id_export_modele; ?>" <?php if ($modele_export->usage == "defaut") {?> checked="checked" <?php } ?> />
                                        ...
                                        <form action="communication_mod_export_stats_vente_def.php" method="post" id="communication_mod_export_stats_vente_def_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_stats_vente_def_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                 ...
                                 Event.observe('def_export_<?php echo $modele_export->id_export_modele; ?>', "click" , function(evt){
                                        if ($('def_export_<?php echo $modele_export->id_export_modele;?>').checked == true) {
                                                $("communication_mod_export_stats_vente_def_<?php echo $modele_export->id_export_modele;?>").submit();
                                        }
                                 } , false);
                                        </script>
                                        <?php } ?> 
                                ...
                                <?php if ($modele_export->usage != "defaut") {?>
                                        ...
                                        <form action="communication_mod_export_stats_vente_des.php" method="post" id="communication_mod_export_stats_vente_des_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_stats_vente_des_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                                
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('unactive_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                                $("communication_mod_export_stats_vente_des_<?php echo $modele_export->id_export_modele;?>").submit();
                                 } , false);
                                        </script>
                                <?php } ?>
                                </td>
        ...
        //if ($export_inactif) {
        ?>
        <span style="cursor:pointer; text-decoration:underline; display:block;" id="show_export_inactif_<?php echo $modele_export->id_export_modele; ?>">Utiliser un nouveau modèle d'impression.</span><br />
        ...
        foreach ($liste_pour_activation as $modele_export) {
                ...
                <table width="100%" border="0">
                        <tr>
                                ...
                                <td style="width:15%"><span style="text-decoration:underline; cursor:pointer" id="show_desc_<?php echo $modele_export->id_export_modele;?>">Plus d'informations</span></td>
                                <!-- <td style="width:15%; color:#999999"><a href="configuration_export_preview.php?id_stat= target="_blank" style="color:#000000">Visualiser</a></td> -->
                                ...
                                <td style="width:15%">
                                        ...
                                        <form action="communication_mod_export_stats_vente_act.php" method="post" id="communication_mod_export_stats_vente_act_<?php echo $modele_export->id_export_modele;?>" name="communication_mod_export_stats_vente_act_<?php echo $modele_export->id_export_modele;?>" target="formFrame" >
                                                <input name="id_export_modele" type="hidden" value="<?php echo $modele_export->id_export_modele; ?>" />
                                                
                                        </form>
                                        <script type="text/javascript">
                                 Event.observe('active_export_<?php echo $modele_export->id_export_modele;?>', "click" , function(evt){
                                        $("communication_mod_export_stats_vente_act_<?php echo $modele_export->id_export_modele;?>").submit();
                                        <?php
                               // }
                                ?>
                                } , false);
