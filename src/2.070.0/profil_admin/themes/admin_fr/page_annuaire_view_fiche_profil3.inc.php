			...
			<div style=" width:100%;">
				...
				foreach ($mes_utilisateurs as $mon_utilisateur){
					...
					if (is_array($user_fonctions)){
						...
						echo '<a href="#" id="maj_droits_user_'.$mon_utilisateur->getRef_user().'" class="common_link">'."Reinitialiser les droits de l'utilisateur ".$mon_utilisateur->getPseudo()."</a><br>";
						?>
						<script type="text/javascript">
